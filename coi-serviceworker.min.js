...
<link crossorigin="anonymous" media="all" rel="stylesheet" href="https://github.githubassets.com/assets/notifications-subscriptions-menu.1bcff9205c241e99cff2.module.css" />
  ...
  <title>coi-serviceworker/coi-serviceworker.min.js at master · gzuidhof/coi-serviceworker · GitHub</title>
  ...
  <meta name="request-id" content="C678:1A6764:19AD48B:2148662:66FA2B79" data-pjax-transient="true"/><meta name="html-safe-nonce" content="2ea1c4fb5299fd0b2c9d47d7339e0390650619aaf696dc493d90bda905503709" data-pjax-transient="true"/><meta name="visitor-payload" content="eyJyZWZlcnJlciI6IiIsInJlcXVlc3RfaWQiOiJDNjc4OjFBNjc2NDoxOUFENDhCOjIxNDg2NjI6NjZGQTJCNzkiLCJ2aXNpdG9yX2lkIjoiNDk0MTcwMDg0ODkzNDMzMzMwNSIsInJlZ2lvbl9lZGdlIjoiaWFkIiwicmVnaW9uX3JlbmRlciI6ImlhZCJ9" data-pjax-transient="true"/><meta name="visitor-hmac" content="e5e3577dac1458fc070dc508c2d78980e2301ba2c04ec251467f5e10d0caf889" data-pjax-transient="true"/>
  ...
  <div class="d-flex flex-column flex-lg-row flex-items-center px-3 px-md-4 px-lg-5 height-full position-relative z-1">
    ...
    <path d="M12.5.75C6.146.75 1 5.896 1 12.25c0 5.089 3.292 9.387 7.863 10.91.575.101.79-.244.79-.546 0-.273-.014-1.178-.014-2.142-2.889.532-3.636-.704-3.866-1.35-.13-.331-.69-1.352-1.18-1.625-.402-.216-.977-.748-.014-.762.906-.014 1.553.834 1.769 1.179 1.035 1.74 2.688 1.25 3.349.948.1-.747.402-1.25.733-1.538-2.559-.287-5.232-1.279-5.232-5.678 0-1.25.445-2.285 1.178-3.09-.115-.288-.517-1.467.115-3.048 0 0 .963-.302 3.163 1.179.92-.259 1.897-.388 2.875-.388.977 0 1.955.13 2.875.388 2.2-1.495 3.162-1.179 3.162-1.179.633 1.581.23 2.76.115 3.048.733.805 1.179 1.825 1.179 3.09 0 4.413-2.688 5.39-5.247 5.678.417.36.776 1.05.776 2.128 0 1.538-.014 2.774-.014 3.162 0 .302.216.662.79.547C20.709 21.637 24 17.324 24 12.25 24 5.896 18.854.75 12.5.75Z"></path>
      ...
      <div class="flex-1 flex-order-2 text-right">
          <a
            href="/login?return_to=https%3A%2F%2Fgithub.com%2Fgzuidhof%2Fcoi-serviceworker%2Fblob%2Fmaster%2Fcoi-serviceworker.min.js"
            class="HeaderMenu-link HeaderMenu-button d-inline-flex d-lg-none flex-order-1 f5 no-underline border color-border-default rounded-2 px-2 py-1 color-fg-inherit js-prevent-focus-on-mobile-nav"
            data-hydro-click="{&quot;event_type&quot;:&quot;authentication.click&quot;,&quot;payload&quot;:{&quot;location_in_page&quot;:&quot;site header menu&quot;,&quot;repository_id&quot;:null,&quot;auth_type&quot;:&quot;SIGN_UP&quot;,&quot;originating_url&quot;:&quot;https://github.com/gzuidhof/coi-serviceworker/blob/master/coi-serviceworker.min.js&quot;,&quot;user_id&quot;:null}}" data-hydro-click-hmac="75db01084a75b83964e5f0a2aaaf0230d506f25c4a8653f42bba0039b817c57e"
...
<qbsearch-input class="search-input" data-scope="repo:gzuidhof/coi-serviceworker" data-custom-scopes-path="/search/custom_scopes" data-delete-custom-scopes-csrf="4xdFjfz77AGkXWSF3h8rGR3xy3MQF4LcOqNXdnWjdxzo0bFeVM_5zI-lkcXBESoHFTjHFHCBGcPOLsKlhfjsFA" data-max-custom-scopes="10" data-header-redesign-enabled="false" data-initial-value="" data-blackbird-suggestions-path="/search/suggestions" data-jump-to-suggestions-path="/_graphql/GetSuggestedNavigationDestinations" data-current-repository="gzuidhof/coi-serviceworker" data-current-org="" data-current-owner="gzuidhof" data-logged-in="false" data-copilot-chat-enabled="false" data-nl-search-enabled="false" data-retain-scroll-position="true">
  <div
    ...
    <path d="M10.68 11.74a6 6 0 0 1-7.922-8.982 6 6 0 0 1 8.982 7.922l3.04 3.04a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215ZM11.5 7a4.499 4.499 0 1 0-8.997 0A4.499 4.499 0 0 0 11.5 7Z"></path>
        ...
        <div data-target="query-builder.styledInputContainer" class="QueryBuilder-StyledInputContainer">
          ...
          <div class="QueryBuilder-InputWrapper">
            ...
            <input id="query-builder-test" name="query-builder-test" value="" autocomplete="off" type="text" role="combobox" spellcheck="false" aria-expanded="false" aria-describedby="validation-d5062eda-acb5-4c78-b2bd-be4ba42f0c60" data-target="query-builder.input" data-action="
...
<template id="device-desktop-icon">
  <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-device-desktop">
    <path d="M14.25 1c.966 0 1.75.784 1.75 1.75v7.5A1.75 1.75 0 0 1 14.25 12h-3.727c.099 1.041.52 1.872 1.292 2.757A.752.752 0 0 1 11.25 16h-6.5a.75.75 0 0 1-.565-1.243c.772-.885 1.192-1.716 1.292-2.757H1.75A1.75 1.75 0 0 1 0 10.25v-7.5C0 1.784.784 1 1.75 1ZM1.75 2.5a.25.25 0 0 0-.25.25v7.5c0 .138.112.25.25.25h12.5a.25.25 0 0 0 .25-.25v-7.5a.25.25 0 0 0-.25-.25ZM9.018 12H6.982a5.72 5.72 0 0 1-.765 2.5h3.566a5.72 5.72 0 0 1-.765-2.5Z"></path>
      ...
      <div class="FormControl-inlineValidation" id="validation-d5062eda-acb5-4c78-b2bd-be4ba42f0c60" hidden="hidden">
  ...
  <div class="Overlay-headerContentWrap">
    ...
    <path d="M3.72 3.72a.75.75 0 0 1 1.06 0L8 6.94l3.22-3.22a.749.749 0 0 1 1.275.326.749.749 0 0 1-.215.734L9.06 8l3.22 3.22a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215L8 9.06l-3.22 3.22a.751.751 0 0 1-1.042-.018.751.751 0 0 1-.018-1.042L6.94 8 3.72 4.78a.75.75 0 0 1 0-1.06Z"></path>
      ...
      <scrollable-region data-labelled-by="feedback-dialog-title">
        <div data-view-component="true" class="Overlay-body">        <!-- '"` --><!-- </textarea></xmp> --></option></form><form id="code-search-feedback-form" data-turbo="false" action="/search/feedback" accept-charset="UTF-8" method="post"><input type="hidden" data-csrf="true" name="authenticity_token" value="YkMa4lBYVQ8ZrMY/31LatGy4sXxJWDV2X9wKJamaGFkHEdx1fm7CIkQE/gkF7mQ/JMi6o3/szLsGq0FyGp5OgA==" />
  ...
  <div class="Overlay-headerContentWrap">
    ...
    <path d="M3.72 3.72a.75.75 0 0 1 1.06 0L8 6.94l3.22-3.22a.749.749 0 0 1 1.275.326.749.749 0 0 1-.215.734L9.06 8l3.22 3.22a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215L8 9.06l-3.22 3.22a.751.751 0 0 1-1.042-.018.751.751 0 0 1-.018-1.042L6.94 8 3.72 4.78a.75.75 0 0 1 0-1.06Z"></path>
      ...
      <scrollable-region data-labelled-by="custom-scopes-dialog-title">
        ...
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form id="custom-scopes-dialog-form" data-turbo="false" action="/search/custom_scopes" accept-charset="UTF-8" method="post"><input type="hidden" data-csrf="true" name="authenticity_token" value="apQgxS1Lky7bNkKtejMHryrCclQQAd5uzcqRnC46nZi4dZ2Tjz1DhMvGdZ8j678NMZ4B36MFeiTUQ9y9LRcz4g==" />
          ...
          <div class="form-group">
            ...
            <auto-check src="/search/custom_scopes/check_name" required>
              <input
                ...
                required
                maxlength="50">
              <input type="hidden" data-csrf="true" value="kZDlcip2NQ6zir3gP4c++0Rck7FBnRdhNCyQmJu3vDCQOK1vFFolU/bT24TEZheQHa0anhLaIgNx2cK2WxbhHA==" />
            </auto-check>
          </div>
    ...
    <button id="icon-button-8f68cdfa-aa77-446d-a014-42bde75fcaac" aria-labelledby="tooltip-42756a34-8e79-42b0-99fe-08c0543d80e1" type="button" data-view-component="true" class="Button Button--iconOnly Button--invisible Button--medium flash-close js-flash-close">  <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-x Button-visual">
    <path d="M3.72 3.72a.75.75 0 0 1 1.06 0L8 6.94l3.22-3.22a.749.749 0 0 1 1.275.326.749.749 0 0 1-.215.734L9.06 8l3.22 3.22a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215L8 9.06l-3.22 3.22a.751.751 0 0 1-1.042-.018.751.751 0 0 1-.018-1.042L6.94 8 3.72 4.78a.75.75 0 0 1 0-1.06Z"></path>
</svg>
</button><tool-tip id="tooltip-42756a34-8e79-42b0-99fe-08c0543d80e1" for="icon-button-8f68cdfa-aa77-446d-a014-42bde75fcaac" popover="manual" data-direction="s" data-type="label" data-view-component="true" class="sr-only position-absolute">Dismiss alert</tool-tip>
...
<div class="flash flash-full   {{ className }}">
  ...
  <li>
            <a href="/login?return_to=%2Fgzuidhof%2Fcoi-serviceworker" rel="nofollow" id="repository-details-watch-button" data-hydro-click="{&quot;event_type&quot;:&quot;authentication.click&quot;,&quot;payload&quot;:{&quot;location_in_page&quot;:&quot;notification subscription menu watch&quot;,&quot;repository_id&quot;:null,&quot;auth_type&quot;:&quot;LOG_IN&quot;,&quot;originating_url&quot;:&quot;https://github.com/gzuidhof/coi-serviceworker/blob/master/coi-serviceworker.min.js&quot;,&quot;user_id&quot;:null}}" data-hydro-click-hmac="814f5927549298c0d61ed6a6d2d5f74a30689cf63a0a844ecdcfd8f746e49cc3" aria-label="You must be signed in to change notification settings" data-view-component="true" class="btn-sm btn">    <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-bell mr-2">
    <path d="M8 16a2 2 0 0 0 1.985-1.75c.017-.137-.097-.25-.235-.25h-3.5c-.138 0-.252.113-.235.25A2 2 0 0 0 8 16ZM3 5a5 5 0 0 1 10 0v2.947c0 .05.015.098.042.139l1.703 2.555A1.519 1.519 0 0 1 13.482 13H2.518a1.516 1.516 0 0 1-1.263-2.36l1.703-2.554A.255.255 0 0 0 3 7.947Zm5-3.5A3.5 3.5 0 0 0 4.5 5v2.947c0 .346-.102.683-.294.97l-1.703 2.556a.017.017 0 0 0-.003.01l.001.006c0 .002.002.004.004.006l.006.004.007.001h10.964l.007-.001.006-.004.004-.006.001-.007a.017.017 0 0 0-.003-.01l-1.703-2.554a1.745 1.745 0 0 1-.294-.97V5A3.5 3.5 0 0 0 8 1.5Z"></path>
</svg>Notifications
</a>    <tool-tip id="tooltip-7259008a-22f9-46e7-91e2-d09ccacb7a96" for="repository-details-watch-button" popover="manual" data-direction="s" data-type="description" data-view-component="true" class="sr-only position-absolute">You must be signed in to change notification settings</tool-tip>

  </li>

  <li>
          <a icon="repo-forked" id="fork-button" href="/login?return_to=%2Fgzuidhof%2Fcoi-serviceworker" rel="nofollow" data-hydro-click="{&quot;event_type&quot;:&quot;authentication.click&quot;,&quot;payload&quot;:{&quot;location_in_page&quot;:&quot;repo details fork button&quot;,&quot;repository_id&quot;:393207442,&quot;auth_type&quot;:&quot;LOG_IN&quot;,&quot;originating_url&quot;:&quot;https://github.com/gzuidhof/coi-serviceworker/blob/master/coi-serviceworker.min.js&quot;,&quot;user_id&quot;:null}}" data-hydro-click-hmac="44673bd6e44926aede17df3c643fd1fb999ec74c52733817e293ccaf6ab98339" data-view-component="true" class="btn-sm btn">    <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-repo-forked mr-2">
  ...
  <li>
        ...
        <a href="/login?return_to=%2Fgzuidhof%2Fcoi-serviceworker" rel="nofollow" data-hydro-click="{&quot;event_type&quot;:&quot;authentication.click&quot;,&quot;payload&quot;:{&quot;location_in_page&quot;:&quot;star button&quot;,&quot;repository_id&quot;:393207442,&quot;auth_type&quot;:&quot;LOG_IN&quot;,&quot;originating_url&quot;:&quot;https://github.com/gzuidhof/coi-serviceworker/blob/master/coi-serviceworker.min.js&quot;,&quot;user_id&quot;:null}}" data-hydro-click-hmac="846fb7e86d9c2df9e7db792a8882f93fcb2667c771ccb3369226fb2384af5f3e" aria-label="You must be signed in to star a repository" data-view-component="true" class="tooltipped tooltipped-sw btn-sm btn">    <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-star v-align-text-bottom d-inline-block mr-2">
  ...
  <focus-group direction="vertical" mnemonics retain>
    <button id="action-menu-42a6ddb7-a729-4bd0-bc2a-9df01e616c49-button" popovertarget="action-menu-42a6ddb7-a729-4bd0-bc2a-9df01e616c49-overlay" aria-controls="action-menu-42a6ddb7-a729-4bd0-bc2a-9df01e616c49-list" aria-haspopup="true" aria-labelledby="tooltip-876b592e-557a-430a-b4fb-ede81b60259e" type="button" data-view-component="true" class="Button Button--iconOnly Button--secondary Button--medium UnderlineNav-item">  <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-kebab-horizontal Button-visual">
    <path d="M8 9a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3ZM1.5 9a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Zm13 0a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Z"></path>
</svg>
</button><tool-tip id="tooltip-876b592e-557a-430a-b4fb-ede81b60259e" for="action-menu-42a6ddb7-a729-4bd0-bc2a-9df01e616c49-button" popover="manual" data-direction="s" data-type="label" data-view-component="true" class="sr-only position-absolute">Additional navigation options</tool-tip>


<anchored-position id="action-menu-42a6ddb7-a729-4bd0-bc2a-9df01e616c49-overlay" anchor="action-menu-42a6ddb7-a729-4bd0-bc2a-9df01e616c49-button" align="start" side="outside-bottom" anchor-offset="normal" popover="auto" data-view-component="true">
  <div data-view-component="true" class="Overlay Overlay--size-auto">
    
      <div data-view-component="true" class="Overlay-body Overlay-body--paddingNone">          <action-list>
  <div data-view-component="true">
    <ul aria-labelledby="action-menu-42a6ddb7-a729-4bd0-bc2a-9df01e616c49-button" id="action-menu-42a6ddb7-a729-4bd0-bc2a-9df01e616c49-list" role="menu" data-view-component="true" class="ActionListWrap--inset ActionListWrap">
        <li hidden="hidden" data-menu-item="i0code-tab" data-targets="action-list.items" role="none" data-view-component="true" class="ActionListItem">
    
    
    <a tabindex="-1" id="item-4612bcd0-56e0-4581-a189-bd6c3aab7a93" href="/gzuidhof/coi-serviceworker" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
    ...
    <a tabindex="-1" id="item-c0dcdb99-9f92-498f-b1c2-62a7acc1596d" href="/gzuidhof/coi-serviceworker/issues" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
          <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-issue-opened">
    <path d="M8 9.5a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Z"></path><path d="M8 0a8 8 0 1 1 0 16A8 8 0 0 1 8 0ZM1.5 8a6.5 6.5 0 1 0 13 0 6.5 6.5 0 0 0-13 0Z"></path>
</svg>
    ...
    <a tabindex="-1" id="item-d72ab2ec-5fbb-4afc-ab41-0f9e6f0ccaf2" href="/gzuidhof/coi-serviceworker/pulls" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
    ...
    <a tabindex="-1" id="item-146624aa-56b0-440a-af17-27e4844b0730" href="/gzuidhof/coi-serviceworker/actions" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
          <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-play">
    <path d="M8 0a8 8 0 1 1 0 16A8 8 0 0 1 8 0ZM1.5 8a6.5 6.5 0 1 0 13 0 6.5 6.5 0 0 0-13 0Zm4.879-2.773 4.264 2.559a.25.25 0 0 1 0 .428l-4.264 2.559A.25.25 0 0 1 6 10.559V5.442a.25.25 0 0 1 .379-.215Z"></path>
</svg>
    ...
    <a tabindex="-1" id="item-c371fcb3-874c-4ccc-89a4-b075e479313b" href="/gzuidhof/coi-serviceworker/projects" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
    ...
    <a tabindex="-1" id="item-6398ced5-4c91-4582-86a7-ba71ee8676b1" href="/gzuidhof/coi-serviceworker/security" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
    ...
    <a tabindex="-1" id="item-27e32932-9db9-416f-a4f0-66da228a22dc" href="/gzuidhof/coi-serviceworker/pulse" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
...
>
  ...
  <script type="application/json" data-target="react-app.embeddedData">{"payload":{"allShortcutsEnabled":false,"fileTree":{"":{"items":[{"name":".gitignore","path":".gitignore","contentType":"file"},{"name":"LICENSE","path":"LICENSE","contentType":"file"},{"name":"README.md","path":"README.md","contentType":"file"},{"name":"coi-serviceworker.js","path":"coi-serviceworker.js","contentType":"file"},{"name":"coi-serviceworker.min.js","path":"coi-serviceworker.min.js","contentType":"file"},{"name":"index.html","path":"index.html","contentType":"file"},{"name":"package-lock.json","path":"package-lock.json","contentType":"file"},{"name":"package.json","path":"package.json","contentType":"file"}],"totalCount":8}},"fileTreeProcessingTime":17.72257,"foldersToFetch":[],"repo":{"id":393207442,"defaultBranch":"master","name":"coi-serviceworker","ownerLogin":"gzuidhof","currentUserCanPush":false,"isFork":false,"isEmpty":false,"createdAt":"2021-08-06T00:56:16.000Z","ownerAvatar":"https://avatars.githubusercontent.com/u/1039510?v=4","public":true,"private":false,"isOrgOwned":false},"codeLineWrapEnabled":false,"symbolsExpanded":false,"treeExpanded":true,"refInfo":{"name":"master","listCacheKey":"v0:1628211377.3985238","canEdit":false,"refType":"branch","currentOid":"7b1d2a092d0d2dd2b7270b6f12f13605de26f214"},"path":"coi-serviceworker.min.js","currentUser":null,"blob":{"rawLines":["/*! coi-serviceworker v0.1.7 - Guido Zuidhof and contributors, licensed under MIT */","let coepCredentialless=!1;\"undefined\"==typeof window?(self.addEventListener(\"install\",(()=\u003eself.skipWaiting())),self.addEventListener(\"activate\",(e=\u003ee.waitUntil(self.clients.claim()))),self.addEventListener(\"message\",(e=\u003e{e.data\u0026\u0026(\"deregister\"===e.data.type?self.registration.unregister().then((()=\u003eself.clients.matchAll())).then((e=\u003e{e.forEach((e=\u003ee.navigate(e.url)))})):\"coepCredentialless\"===e.data.type\u0026\u0026(coepCredentialless=e.data.value))})),self.addEventListener(\"fetch\",(function(e){const o=e.request;if(\"only-if-cached\"===o.cache\u0026\u0026\"same-origin\"!==o.mode)return;const s=coepCredentialless\u0026\u0026\"no-cors\"===o.mode?new Request(o,{credentials:\"omit\"}):o;e.respondWith(fetch(s).then((e=\u003e{if(0===e.status)return e;const o=new Headers(e.headers);return o.set(\"Cross-Origin-Embedder-Policy\",coepCredentialless?\"credentialless\":\"require-corp\"),coepCredentialless||o.set(\"Cross-Origin-Resource-Policy\",\"cross-origin\"),o.set(\"Cross-Origin-Opener-Policy\",\"same-origin\"),new Response(e.body,{status:e.status,statusText:e.statusText,headers:o})})).catch((e=\u003econsole.error(e))))}))):(()=\u003e{const e=window.sessionStorage.getItem(\"coiReloadedBySelf\");window.sessionStorage.removeItem(\"coiReloadedBySelf\");const o=\"coepdegrade\"==e,s={shouldRegister:()=\u003e!e,shouldDeregister:()=\u003e!1,coepCredentialless:()=\u003e!0,coepDegrade:()=\u003e!0,doReload:()=\u003ewindow.location.reload(),quiet:!1,...window.coi},r=navigator,t=r.serviceWorker\u0026\u0026r.serviceWorker.controller;t\u0026\u0026!window.crossOriginIsolated\u0026\u0026window.sessionStorage.setItem(\"coiCoepHasFailed\",\"true\");const i=window.sessionStorage.getItem(\"coiCoepHasFailed\");if(t){const e=s.coepDegrade()\u0026\u0026!(o||window.crossOriginIsolated);r.serviceWorker.controller.postMessage({type:\"coepCredentialless\",value:!(e||i\u0026\u0026s.coepDegrade())\u0026\u0026s.coepCredentialless()}),e\u0026\u0026(!s.quiet\u0026\u0026console.log(\"Reloading page to degrade COEP.\"),window.sessionStorage.setItem(\"coiReloadedBySelf\",\"coepdegrade\"),s.doReload(\"coepdegrade\")),s.shouldDeregister()\u0026\u0026r.serviceWorker.controller.postMessage({type:\"deregister\"})}!1===window.crossOriginIsolated\u0026\u0026s.shouldRegister()\u0026\u0026(window.isSecureContext?r.serviceWorker?r.serviceWorker.register(window.document.currentScript.src).then((e=\u003e{!s.quiet\u0026\u0026console.log(\"COOP/COEP Service Worker registered\",e.scope),e.addEventListener(\"updatefound\",(()=\u003e{!s.quiet\u0026\u0026console.log(\"Reloading page to make use of updated COOP/COEP Service Worker.\"),window.sessionStorage.setItem(\"coiReloadedBySelf\",\"updatefound\"),s.doReload()})),e.active\u0026\u0026!r.serviceWorker.controller\u0026\u0026(!s.quiet\u0026\u0026console.log(\"Reloading page to make use of COOP/COEP Service Worker.\"),window.sessionStorage.setItem(\"coiReloadedBySelf\",\"notcontrolling\"),s.doReload())}),(e=\u003e{!s.quiet\u0026\u0026console.error(\"COOP/COEP Service Worker failed to register:\",e)})):!s.quiet\u0026\u0026console.error(\"COOP/COEP Service Worker not registered, perhaps due to private mode.\"):!s.quiet\u0026\u0026console.log(\"COOP/COEP Service Worker not registered, a secure context is required.\"))})();"],"stylingDirectives":[[{"s":0,"e":84,"c":"pl-c"}],[{"s":0,"e":3,"c":"pl-k"},{"s":4,"e":22,"c":"pl-s1"},{"s":22,"e":23,"c":"pl-c1"},{"s":23,"e":24,"c":"pl-c1"},{"s":24,"e":25,"c":"pl-c1"},{"s":25,"e":26,"c":"pl-kos"},{"s":26,"e":37,"c":"pl-s"},{"s":37,"e":39,"c":"pl-c1"},{"s":39,"e":45,"c":"pl-k"},{"s":46,"e":52,"c":"pl-smi"},{"s":53,"e":54,"c":"pl-kos"},{"s":54,"e":58,"c":"pl-s1"},{"s":58,"e":59,"c":"pl-kos"},{"s":59,"e":75,"c":"pl-en"},{"s":75,"e":76,"c":"pl-kos"},{"s":76,"e":85,"c":"pl-s"},{"s":85,"e":86,"c":"pl-kos"},{"s":86,"e":87,"c":"pl-kos"},{"s":87,"e":88,"c":"pl-kos"},{"s":88,"e":89,"c":"pl-kos"},{"s":89,"e":91,"c":"pl-c1"},{"s":91,"e":95,"c":"pl-s1"},{"s":95,"e":96,"c":"pl-kos"},{"s":96,"e":107,"c":"pl-en"},{"s":107,"e":108,"c":"pl-kos"},{"s":108,"e":109,"c":"pl-kos"},{"s":109,"e":110,"c":"pl-kos"},{"s":110,"e":111,"c":"pl-kos"},{"s":111,"e":112,"c":"pl-kos"},{"s":112,"e":116,"c":"pl-s1"},{"s":116,"e":117,"c":"pl-kos"},{"s":117,"e":133,"c":"pl-en"},{"s":133,"e":134,"c":"pl-kos"},{"s":134,"e":144,"c":"pl-s"},{"s":144,"e":145,"c":"pl-kos"},{"s":145,"e":146,"c":"pl-kos"},{"s":146,"e":147,"c":"pl-s1"},{"s":147,"e":149,"c":"pl-c1"},{"s":149,"e":150,"c":"pl-s1"},{"s":150,"e":151,"c":"pl-kos"},{"s":151,"e":160,"c":"pl-en"},{"s":160,"e":161,"c":"pl-kos"},{"s":161,"e":165,"c":"pl-s1"},{"s":165,"e":166,"c":"pl-kos"},{"s":166,"e":173,"c":"pl-c1"},{"s":173,"e":174,"c":"pl-kos"},{"s":174,"e":179,"c":"pl-en"},{"s":179,"e":180,"c":"pl-kos"},{"s":180,"e":181,"c":"pl-kos"},{"s":181,"e":182,"c":"pl-kos"},{"s":182,"e":183,"c":"pl-kos"},{"s":183,"e":184,"c":"pl-kos"},{"s":184,"e":185,"c":"pl-kos"},{"s":185,"e":189,"c":"pl-s1"},{"s":189,"e":190,"c":"pl-kos"},{"s":190,"e":206,"c":"pl-en"},{"s":206,"e":207,"c":"pl-kos"},{"s":207,"e":216,"c":"pl-s"},{"s":216,"e":217,"c":"pl-kos"},{"s":217,"e":218,"c":"pl-kos"},{"s":218,"e":219,"c":"pl-s1"},{"s":219,"e":221,"c":"pl-c1"},{"s":221,"e":222,"c":"pl-kos"},{"s":222,"e":223,"c":"pl-s1"},{"s":223,"e":224,"c":"pl-kos"},{"s":224,"e":228,"c":"pl-c1"},{"s":228,"e":230,"c":"pl-c1"},{"s":230,"e":231,"c":"pl-kos"},{"s":231,"e":243,"c":"pl-s"},{"s":243,"e":246,"c":"pl-c1"},{"s":246,"e":247,"c":"pl-s1"},{"s":247,"e":248,"c":"pl-kos"},{"s":248,"e":252,"c":"pl-c1"},{"s":252,"e":253,"c":"pl-kos"},{"s":253,"e":257,"c":"pl-c1"},{"s":258,"e":262,"c":"pl-s1"},{"s":262,"e":263,"c":"pl-kos"},{"s":263,"e":275,"c":"pl-c1"},{"s":275,"e":276,"c":"pl-kos"},{"s":276,"e":286,"c":"pl-en"},{"s":286,"e":287,"c":"pl-kos"},{"s":287,"e":288,"c":"pl-kos"},{"s":288,"e":289,"c":"pl-kos"},{"s":289,"e":293,"c":"pl-en"},{"s":293,"e":294,"c":"pl-kos"},{"s":294,"e":295,"c":"pl-kos"},{"s":295,"e":296,"c":"pl-kos"},{"s":296,"e":297,"c":"pl-kos"},{"s":297,"e":299,"c":"pl-c1"},{"s":299,"e":303,"c":"pl-s1"},{"s":303,"e":304,"c":"pl-kos"},{"s":304,"e":311,"c":"pl-c1"},{"s":311,"e":312,"c":"pl-kos"},{"s":312,"e":320,"c":"pl-en"},{"s":320,"e":321,"c":"pl-kos"},{"s":321,"e":322,"c":"pl-kos"},{"s":322,"e":323,"c":"pl-kos"},{"s":323,"e":324,"c":"pl-kos"},{"s":324,"e":325,"c":"pl-kos"},{"s":325,"e":329,"c":"pl-en"},{"s":329,"e":330,"c":"pl-kos"},{"s":330,"e":331,"c":"pl-kos"},{"s":331,"e":332,"c":"pl-s1"},{"s":332,"e":334,"c":"pl-c1"},{"s":334,"e":335,"c":"pl-kos"},{"s":335,"e":336,"c":"pl-s1"},{"s":336,"e":337,"c":"pl-kos"},{"s":337,"e":344,"c":"pl-en"},{"s":344,"e":345,"c":"pl-kos"},{"s":345,"e":346,"c":"pl-kos"},{"s":346,"e":347,"c":"pl-s1"},{"s":347,"e":349,"c":"pl-c1"},{"s":349,"e":350,"c":"pl-s1"},{"s":350,"e":351,"c":"pl-kos"},{"s":351,"e":359,"c":"pl-en"},{"s":359,"e":360,"c":"pl-kos"},{"s":360,"e":361,"c":"pl-s1"},{"s":361,"e":362,"c":"pl-kos"},{"s":362,"e":365,"c":"pl-c1"},{"s":365,"e":366,"c":"pl-kos"},{"s":366,"e":367,"c":"pl-kos"},{"s":367,"e":368,"c":"pl-kos"},{"s":368,"e":369,"c":"pl-kos"},{"s":369,"e":370,"c":"pl-kos"},{"s":370,"e":371,"c":"pl-kos"},{"s":372,"e":392,"c":"pl-s"},{"s":392,"e":395,"c":"pl-c1"},{"s":395,"e":396,"c":"pl-s1"},{"s":396,"e":397,"c":"pl-kos"},{"s":397,"e":401,"c":"pl-c1"},{"s":401,"e":402,"c":"pl-kos"},{"s":402,"e":406,"c":"pl-c1"},{"s":406,"e":408,"c":"pl-c1"},{"s":408,"e":409,"c":"pl-kos"},{"s":409,"e":427,"c":"pl-s1"},{"s":427,"e":428,"c":"pl-c1"},{"s":428,"e":429,"c":"pl-s1"},{"s":429,"e":430,"c":"pl-kos"},{"s":430,"e":434,"c":"pl-c1"},{"s":434,"e":435,"c":"pl-kos"},{"s":435,"e":440,"c":"pl-c1"},{"s":440,"e":441,"c":"pl-kos"},{"s":441,"e":442,"c":"pl-kos"},{"s":442,"e":443,"c":"pl-kos"},{"s":443,"e":444,"c":"pl-kos"},{"s":444,"e":445,"c":"pl-kos"},{"s":445,"e":446,"c":"pl-kos"},{"s":446,"e":450,"c":"pl-s1"},{"s":450,"e":451,"c":"pl-kos"},{"s":451,"e":467,"c":"pl-en"},{"s":467,"e":468,"c":"pl-kos"},{"s":468,"e":475,"c":"pl-s"},{"s":475,"e":476,"c":"pl-kos"},{"s":476,"e":477,"c":"pl-kos"},{"s":477,"e":485,"c":"pl-k"},{"s":485,"e":486,"c":"pl-kos"},{"s":486,"e":487,"c":"pl-s1"},{"s":487,"e":488,"c":"pl-kos"},{"s":488,"e":489,"c":"pl-kos"},{"s":489,"e":494,"c":"pl-k"},{"s":495,"e":496,"c":"pl-s1"},{"s":496,"e":497,"c":"pl-c1"},{"s":497,"e":498,"c":"pl-s1"},{"s":498,"e":499,"c":"pl-kos"},{"s":499,"e":506,"c":"pl-c1"},{"s":506,"e":507,"c":"pl-kos"},{"s":507,"e":509,"c":"pl-k"},{"s":509,"e":510,"c":"pl-kos"},{"s":510,"e":526,"c":"pl-s"},{"s":526,"e":529,"c":"pl-c1"},{"s":529,"e":530,"c":"pl-s1"},{"s":530,"e":531,"c":"pl-kos"},{"s":531,"e":536,"c":"pl-c1"},{"s":536,"e":538,"c":"pl-c1"},{"s":538,"e":551,"c":"pl-s"},{"s":551,"e":554,"c":"pl-c1"},{"s":554,"e":555,"c":"pl-s1"},{"s":555,"e":556,"c":"pl-kos"},{"s":556,"e":560,"c":"pl-c1"},{"s":560,"e":561,"c":"pl-kos"},{"s":561,"e":567,"c":"pl-k"},{"s":567,"e":568,"c":"pl-kos"},{"s":568,"e":573,"c":"pl-k"},{"s":574,"e":575,"c":"pl-s1"},{"s":575,"e":576,"c":"pl-c1"},{"s":576,"e":594,"c":"pl-s1"},{"s":594,"e":596,"c":"pl-c1"},{"s":596,"e":605,"c":"pl-s"},{"s":605,"e":608,"c":"pl-c1"},{"s":608,"e":609,"c":"pl-s1"},{"s":609,"e":610,"c":"pl-kos"},{"s":610,"e":614,"c":"pl-c1"},{"s":615,"e":618,"c":"pl-k"},{"s":619,"e":626,"c":"pl-v"},{"s":626,"e":627,"c":"pl-kos"},{"s":627,"e":628,"c":"pl-s1"},{"s":628,"e":629,"c":"pl-kos"},{"s":629,"e":630,"c":"pl-kos"},{"s":630,"e":641,"c":"pl-c1"},{"s":642,"e":648,"c":"pl-s"},{"s":648,"e":649,"c":"pl-kos"},{"s":649,"e":650,"c":"pl-kos"},{"s":651,"e":652,"c":"pl-s1"},{"s":652,"e":653,"c":"pl-kos"},{"s":653,"e":654,"c":"pl-s1"},{"s":654,"e":655,"c":"pl-kos"},{"s":655,"e":666,"c":"pl-en"},{"s":666,"e":667,"c":"pl-kos"},{"s":667,"e":672,"c":"pl-en"},{"s":672,"e":673,"c":"pl-kos"},{"s":673,"e":674,"c":"pl-s1"},{"s":674,"e":675,"c":"pl-kos"},{"s":675,"e":676,"c":"pl-kos"},{"s":676,"e":680,"c":"pl-en"},{"s":680,"e":681,"c":"pl-kos"},{"s":681,"e":682,"c":"pl-kos"},{"s":682,"e":683,"c":"pl-s1"},{"s":683,"e":685,"c":"pl-c1"},{"s":685,"e":686,"c":"pl-kos"},{"s":686,"e":688,"c":"pl-k"},{"s":688,"e":689,"c":"pl-kos"},{"s":689,"e":690,"c":"pl-c1"},{"s":690,"e":693,"c":"pl-c1"},{"s":693,"e":694,"c":"pl-s1"},{"s":694,"e":695,"c":"pl-kos"},{"s":695,"e":701,"c":"pl-c1"},{"s":701,"e":702,"c":"pl-kos"},{"s":702,"e":708,"c":"pl-k"},{"s":709,"e":710,"c":"pl-s1"},{"s":710,"e":711,"c":"pl-kos"},{"s":711,"e":716,"c":"pl-k"},{"s":717,"e":718,"c":"pl-s1"},{"s":718,"e":719,"c":"pl-c1"},{"s":719,"e":722,"c":"pl-k"},{"s":723,"e":730,"c":"pl-v"},{"s":730,"e":731,"c":"pl-kos"},{"s":731,"e":732,"c":"pl-s1"},{"s":732,"e":733,"c":"pl-kos"},{"s":733,"e":740,"c":"pl-c1"},{"s":740,"e":741,"c":"pl-kos"},{"s":741,"e":742,"c":"pl-kos"},{"s":742,"e":748,"c":"pl-k"},{"s":749,"e":750,"c":"pl-s1"},{"s":750,"e":751,"c":"pl-kos"},{"s":751,"e":754,"c":"pl-en"},{"s":754,"e":755,"c":"pl-kos"},{"s":755,"e":785,"c":"pl-s"},{"s":785,"e":786,"c":"pl-kos"},{"s":786,"e":804,"c":"pl-s1"},{"s":805,"e":821,"c":"pl-s"},{"s":822,"e":836,"c":"pl-s"},{"s":836,"e":837,"c":"pl-kos"},{"s":837,"e":838,"c":"pl-kos"},{"s":838,"e":856,"c":"pl-s1"},{"s":856,"e":858,"c":"pl-c1"},{"s":858,"e":859,"c":"pl-s1"},{"s":859,"e":860,"c":"pl-kos"},{"s":860,"e":863,"c":"pl-en"},{"s":863,"e":864,"c":"pl-kos"},{"s":864,"e":894,"c":"pl-s"},{"s":894,"e":895,"c":"pl-kos"},{"s":895,"e":909,"c":"pl-s"},{"s":909,"e":910,"c":"pl-kos"},{"s":910,"e":911,"c":"pl-kos"},{"s":911,"e":912,"c":"pl-s1"},{"s":912,"e":913,"c":"pl-kos"},{"s":913,"e":916,"c":"pl-en"},{"s":916,"e":917,"c":"pl-kos"},{"s":917,"e":945,"c":"pl-s"},{"s":945,"e":946,"c":"pl-kos"},{"s":946,"e":959,"c":"pl-s"},{"s":959,"e":960,"c":"pl-kos"},{"s":960,"e":961,"c":"pl-kos"},{"s":961,"e":964,"c":"pl-k"},{"s":965,"e":973,"c":"pl-v"},{"s":973,"e":974,"c":"pl-kos"},{"s":974,"e":975,"c":"pl-s1"},{"s":975,"e":976,"c":"pl-kos"},{"s":976,"e":980,"c":"pl-c1"},{"s":980,"e":981,"c":"pl-kos"},{"s":981,"e":982,"c":"pl-kos"},{"s":982,"e":988,"c":"pl-c1"},{"s":989,"e":990,"c":"pl-s1"},{"s":990,"e":991,"c":"pl-kos"},{"s":991,"e":997,"c":"pl-c1"},{"s":997,"e":998,"c":"pl-kos"},{"s":998,"e":1008,"c":"pl-c1"},{"s":1009,"e":1010,"c":"pl-s1"},{"s":1010,"e":1011,"c":"pl-kos"},{"s":1011,"e":1021,"c":"pl-c1"},{"s":1021,"e":1022,"c":"pl-kos"},{"s":1022,"e":1029,"c":"pl-c1"},{"s":1030,"e":1031,"c":"pl-s1"},{"s":1031,"e":1032,"c":"pl-kos"},{"s":1032,"e":1033,"c":"pl-kos"},{"s":1033,"e":1034,"c":"pl-kos"},{"s":1034,"e":1035,"c":"pl-kos"},{"s":1035,"e":1036,"c":"pl-kos"},{"s":1036,"e":1037,"c":"pl-kos"},{"s":1037,"e":1042,"c":"pl-en"},{"s":1042,"e":1043,"c":"pl-kos"},{"s":1043,"e":1044,"c":"pl-kos"},{"s":1044,"e":1045,"c":"pl-s1"},{"s":1045,"e":1047,"c":"pl-c1"},{"s":1047,"e":1054,"c":"pl-smi"},{"s":1054,"e":1055,"c":"pl-kos"},{"s":1055,"e":1060,"c":"pl-en"},{"s":1060,"e":1061,"c":"pl-kos"},{"s":1061,"e":1062,"c":"pl-s1"},{"s":1062,"e":1063,"c":"pl-kos"},{"s":1063,"e":1064,"c":"pl-kos"},{"s":1064,"e":1065,"c":"pl-kos"},{"s":1065,"e":1066,"c":"pl-kos"},{"s":1066,"e":1067,"c":"pl-kos"},{"s":1067,"e":1068,"c":"pl-kos"},{"s":1068,"e":1069,"c":"pl-kos"},{"s":1069,"e":1070,"c":"pl-kos"},{"s":1071,"e":1072,"c":"pl-kos"},{"s":1072,"e":1073,"c":"pl-kos"},{"s":1073,"e":1074,"c":"pl-kos"},{"s":1074,"e":1076,"c":"pl-c1"},{"s":1076,"e":1077,"c":"pl-kos"},{"s":1077,"e":1082,"c":"pl-k"},{"s":1083,"e":1084,"c":"pl-s1"},{"s":1084,"e":1085,"c":"pl-c1"},{"s":1085,"e":1091,"c":"pl-smi"},{"s":1091,"e":1092,"c":"pl-kos"},{"s":1092,"e":1106,"c":"pl-c1"},{"s":1106,"e":1107,"c":"pl-kos"},{"s":1107,"e":1114,"c":"pl-en"},{"s":1114,"e":1115,"c":"pl-kos"},{"s":1115,"e":1134,"c":"pl-s"},{"s":1134,"e":1135,"c":"pl-kos"},{"s":1135,"e":1136,"c":"pl-kos"},{"s":1136,"e":1142,"c":"pl-smi"},{"s":1142,"e":1143,"c":"pl-kos"},{"s":1143,"e":1157,"c":"pl-c1"},{"s":1157,"e":1158,"c":"pl-kos"},{"s":1158,"e":1168,"c":"pl-en"},{"s":1168,"e":1169,"c":"pl-kos"},{"s":1169,"e":1188,"c":"pl-s"},{"s":1188,"e":1189,"c":"pl-kos"},{"s":1189,"e":1190,"c":"pl-kos"},{"s":1190,"e":1195,"c":"pl-k"},{"s":1196,"e":1197,"c":"pl-s1"},{"s":1197,"e":1198,"c":"pl-c1"},{"s":1198,"e":1211,"c":"pl-s"},{"s":1211,"e":1213,"c":"pl-c1"},{"s":1213,"e":1214,"c":"pl-s1"},{"s":1214,"e":1215,"c":"pl-kos"},{"s":1215,"e":1216,"c":"pl-s1"},{"s":1216,"e":1217,"c":"pl-c1"},{"s":1217,"e":1218,"c":"pl-kos"},{"s":1218,"e":1232,"c":"pl-en"},{"s":1233,"e":1234,"c":"pl-kos"},{"s":1234,"e":1235,"c":"pl-kos"},{"s":1235,"e":1237,"c":"pl-c1"},{"s":1237,"e":1238,"c":"pl-c1"},{"s":1238,"e":1239,"c":"pl-s1"},{"s":1239,"e":1240,"c":"pl-kos"},{"s":1240,"e":1256,"c":"pl-en"},{"s":1257,"e":1258,"c":"pl-kos"},{"s":1258,"e":1259,"c":"pl-kos"},{"s":1259,"e":1261,"c":"pl-c1"},{"s":1261,"e":1262,"c":"pl-c1"},{"s":1262,"e":1263,"c":"pl-c1"},{"s":1263,"e":1264,"c":"pl-kos"},{"s":1264,"e":1282,"c":"pl-en"},{"s":1283,"e":1284,"c":"pl-kos"},{"s":1284,"e":1285,"c":"pl-kos"},{"s":1285,"e":1287,"c":"pl-c1"},{"s":1287,"e":1288,"c":"pl-c1"},{"s":1288,"e":1289,"c":"pl-c1"},{"s":1289,"e":1290,"c":"pl-kos"},{"s":1290,"e":1301,"c":"pl-en"},{"s":1302,"e":1303,"c":"pl-kos"},{"s":1303,"e":1304,"c":"pl-kos"},{"s":1304,"e":1306,"c":"pl-c1"},{"s":1306,"e":1307,"c":"pl-c1"},{"s":1307,"e":1308,"c":"pl-c1"},{"s":1308,"e":1309,"c":"pl-kos"},{"s":1309,"e":1317,"c":"pl-en"},{"s":1318,"e":1319,"c":"pl-kos"},{"s":1319,"e":1320,"c":"pl-kos"},{"s":1320,"e":1322,"c":"pl-c1"},{"s":1322,"e":1328,"c":"pl-smi"},{"s":1328,"e":1329,"c":"pl-kos"},{"s":1329,"e":1337,"c":"pl-c1"},{"s":1337,"e":1338,"c":"pl-kos"},{"s":1338,"e":1344,"c":"pl-en"},{"s":1344,"e":1345,"c":"pl-kos"},{"s":1345,"e":1346,"c":"pl-kos"},{"s":1346,"e":1347,"c":"pl-kos"},{"s":1347,"e":1352,"c":"pl-c1"},{"s":1353,"e":1354,"c":"pl-c1"},{"s":1354,"e":1355,"c":"pl-c1"},{"s":1355,"e":1356,"c":"pl-kos"},{"s":1359,"e":1365,"c":"pl-smi"},{"s":1365,"e":1366,"c":"pl-kos"},{"s":1366,"e":1369,"c":"pl-c1"},{"s":1369,"e":1370,"c":"pl-kos"},{"s":1370,"e":1371,"c":"pl-kos"},{"s":1371,"e":1372,"c":"pl-s1"},{"s":1372,"e":1373,"c":"pl-c1"},{"s":1373,"e":1382,"c":"pl-s1"},{"s":1382,"e":1383,"c":"pl-kos"},{"s":1383,"e":1384,"c":"pl-s1"},{"s":1384,"e":1385,"c":"pl-c1"},{"s":1385,"e":1386,"c":"pl-s1"},{"s":1386,"e":1387,"c":"pl-kos"},{"s":1387,"e":1400,"c":"pl-c1"},{"s":1400,"e":1402,"c":"pl-c1"},{"s":1402,"e":1403,"c":"pl-s1"},{"s":1403,"e":1404,"c":"pl-kos"},{"s":1404,"e":1417,"c":"pl-c1"},{"s":1417,"e":1418,"c":"pl-kos"},{"s":1418,"e":1428,"c":"pl-c1"},{"s":1428,"e":1429,"c":"pl-kos"},{"s":1429,"e":1430,"c":"pl-s1"},{"s":1430,"e":1432,"c":"pl-c1"},{"s":1432,"e":1433,"c":"pl-c1"},{"s":1433,"e":1439,"c":"pl-smi"},{"s":1439,"e":1440,"c":"pl-kos"},{"s":1440,"e":1459,"c":"pl-c1"},{"s":1459,"e":1461,"c":"pl-c1"},{"s":1461,"e":1467,"c":"pl-smi"},{"s":1467,"e":1468,"c":"pl-kos"},{"s":1468,"e":1482,"c":"pl-c1"},{"s":1482,"e":1483,"c":"pl-kos"},{"s":1483,"e":1490,"c":"pl-en"},{"s":1490,"e":1491,"c":"pl-kos"},{"s":1491,"e":1509,"c":"pl-s"},{"s":1509,"e":1510,"c":"pl-kos"},{"s":1510,"e":1516,"c":"pl-s"},{"s":1516,"e":1517,"c":"pl-kos"},{"s":1517,"e":1518,"c":"pl-kos"},{"s":1518,"e":1523,"c":"pl-k"},{"s":1524,"e":1525,"c":"pl-s1"},{"s":1525,"e":1526,"c":"pl-c1"},{"s":1526,"e":1532,"c":"pl-smi"},{"s":1532,"e":1533,"c":"pl-kos"},{"s":1533,"e":1547,"c":"pl-c1"},{"s":1547,"e":1548,"c":"pl-kos"},{"s":1548,"e":1555,"c":"pl-en"},{"s":1555,"e":1556,"c":"pl-kos"},{"s":1556,"e":1574,"c":"pl-s"},{"s":1574,"e":1575,"c":"pl-kos"},{"s":1575,"e":1576,"c":"pl-kos"},{"s":1576,"e":1578,"c":"pl-k"},{"s":1578,"e":1579,"c":"pl-kos"},{"s":1579,"e":1580,"c":"pl-s1"},{"s":1580,"e":1581,"c":"pl-kos"},{"s":1581,"e":1582,"c":"pl-kos"},{"s":1582,"e":1587,"c":"pl-k"},{"s":1588,"e":1589,"c":"pl-s1"},{"s":1589,"e":1590,"c":"pl-c1"},{"s":1590,"e":1591,"c":"pl-s1"},{"s":1591,"e":1592,"c":"pl-kos"},{"s":1592,"e":1603,"c":"pl-en"},{"s":1603,"e":1604,"c":"pl-kos"},{"s":1604,"e":1605,"c":"pl-kos"},{"s":1605,"e":1607,"c":"pl-c1"},{"s":1607,"e":1608,"c":"pl-c1"},{"s":1608,"e":1609,"c":"pl-kos"},{"s":1609,"e":1610,"c":"pl-s1"},{"s":1610,"e":1612,"c":"pl-c1"},{"s":1612,"e":1618,"c":"pl-smi"},{"s":1618,"e":1619,"c":"pl-kos"},{"s":1619,"e":1638,"c":"pl-c1"},{"s":1638,"e":1639,"c":"pl-kos"},{"s":1639,"e":1640,"c":"pl-kos"},{"s":1640,"e":1641,"c":"pl-s1"},{"s":1641,"e":1642,"c":"pl-kos"},{"s":1642,"e":1655,"c":"pl-c1"},{"s":1655,"e":1656,"c":"pl-kos"},{"s":1656,"e":1666,"c":"pl-c1"},{"s":1666,"e":1667,"c":"pl-kos"},{"s":1667,"e":1678,"c":"pl-en"},{"s":1678,"e":1679,"c":"pl-kos"},{"s":1679,"e":1680,"c":"pl-kos"},{"s":1680,"e":1684,"c":"pl-c1"},{"s":1685,"e":1705,"c":"pl-s"},{"s":1705,"e":1706,"c":"pl-kos"},{"s":1706,"e":1711,"c":"pl-c1"},{"s":1712,"e":1713,"c":"pl-c1"},{"s":1713,"e":1714,"c":"pl-kos"},{"s":1714,"e":1715,"c":"pl-s1"},{"s":1715,"e":1717,"c":"pl-c1"},{"s":1717,"e":1718,"c":"pl-s1"},{"s":1718,"e":1720,"c":"pl-c1"},{"s":1720,"e":1721,"c":"pl-s1"},{"s":1721,"e":1722,"c":"pl-kos"},{"s":1722,"e":1733,"c":"pl-en"},{"s":1733,"e":1734,"c":"pl-kos"},{"s":1734,"e":1735,"c":"pl-kos"},{"s":1735,"e":1736,"c":"pl-kos"},{"s":1736,"e":1738,"c":"pl-c1"},{"s":1738,"e":1739,"c":"pl-s1"},{"s":1739,"e":1740,"c":"pl-kos"},{"s":1740,"e":1758,"c":"pl-en"},{"s":1758,"e":1759,"c":"pl-kos"},{"s":1759,"e":1760,"c":"pl-kos"},{"s":1760,"e":1761,"c":"pl-kos"},{"s":1761,"e":1762,"c":"pl-kos"},{"s":1762,"e":1763,"c":"pl-kos"},{"s":1763,"e":1764,"c":"pl-s1"},{"s":1764,"e":1766,"c":"pl-c1"},{"s":1766,"e":1767,"c":"pl-kos"},{"s":1767,"e":1768,"c":"pl-c1"},{"s":1768,"e":1769,"c":"pl-s1"},{"s":1769,"e":1770,"c":"pl-kos"},{"s":1770,"e":1775,"c":"pl-c1"},{"s":1775,"e":1777,"c":"pl-c1"},{"s":1777,"e":1784,"c":"pl-smi"},{"s":1784,"e":1785,"c":"pl-kos"},{"s":1785,"e":1788,"c":"pl-en"},{"s":1788,"e":1789,"c":"pl-kos"},{"s":1789,"e":1822,"c":"pl-s"},{"s":1822,"e":1823,"c":"pl-kos"},{"s":1823,"e":1824,"c":"pl-kos"},{"s":1824,"e":1830,"c":"pl-smi"},{"s":1830,"e":1831,"c":"pl-kos"},{"s":1831,"e":1845,"c":"pl-c1"},{"s":1845,"e":1846,"c":"pl-kos"},{"s":1846,"e":1853,"c":"pl-en"},{"s":1853,"e":1854,"c":"pl-kos"},{"s":1854,"e":1873,"c":"pl-s"},{"s":1873,"e":1874,"c":"pl-kos"},{"s":1874,"e":1887,"c":"pl-s"},{"s":1887,"e":1888,"c":"pl-kos"},{"s":1888,"e":1889,"c":"pl-kos"},{"s":1889,"e":1890,"c":"pl-s1"},{"s":1890,"e":1891,"c":"pl-kos"},{"s":1891,"e":1899,"c":"pl-en"},{"s":1899,"e":1900,"c":"pl-kos"},{"s":1900,"e":1913,"c":"pl-s"},{"s":1913,"e":1914,"c":"pl-kos"},{"s":1914,"e":1915,"c":"pl-kos"},{"s":1915,"e":1916,"c":"pl-kos"},{"s":1916,"e":1917,"c":"pl-s1"},{"s":1917,"e":1918,"c":"pl-kos"},{"s":1918,"e":1934,"c":"pl-en"},{"s":1934,"e":1935,"c":"pl-kos"},{"s":1935,"e":1936,"c":"pl-kos"},{"s":1936,"e":1938,"c":"pl-c1"},{"s":1938,"e":1939,"c":"pl-s1"},{"s":1939,"e":1940,"c":"pl-kos"},{"s":1940,"e":1953,"c":"pl-c1"},{"s":1953,"e":1954,"c":"pl-kos"},{"s":1954,"e":1964,"c":"pl-c1"},{"s":1964,"e":1965,"c":"pl-kos"},{"s":1965,"e":1976,"c":"pl-en"},{"s":1976,"e":1977,"c":"pl-kos"},{"s":1977,"e":1978,"c":"pl-kos"},{"s":1978,"e":1982,"c":"pl-c1"},{"s":1983,"e":1995,"c":"pl-s"},{"s":1995,"e":1996,"c":"pl-kos"},{"s":1996,"e":1997,"c":"pl-kos"},{"s":1997,"e":1998,"c":"pl-kos"},{"s":1998,"e":1999,"c":"pl-c1"},{"s":1999,"e":2000,"c":"pl-c1"},{"s":2000,"e":2003,"c":"pl-c1"},{"s":2003,"e":2009,"c":"pl-smi"},{"s":2009,"e":2010,"c":"pl-kos"},{"s":2010,"e":2029,"c":"pl-c1"},{"s":2029,"e":2031,"c":"pl-c1"},{"s":2031,"e":2032,"c":"pl-s1"},{"s":2032,"e":2033,"c":"pl-kos"},{"s":2033,"e":2047,"c":"pl-en"},{"s":2047,"e":2048,"c":"pl-kos"},{"s":2048,"e":2049,"c":"pl-kos"},{"s":2049,"e":2051,"c":"pl-c1"},{"s":2051,"e":2052,"c":"pl-kos"},{"s":2052,"e":2058,"c":"pl-smi"},{"s":2058,"e":2059,"c":"pl-kos"},{"s":2059,"e":2074,"c":"pl-c1"},{"s":2075,"e":2076,"c":"pl-s1"},{"s":2076,"e":2077,"c":"pl-kos"},{"s":2077,"e":2090,"c":"pl-c1"},{"s":2091,"e":2092,"c":"pl-s1"},{"s":2092,"e":2093,"c":"pl-kos"},{"s":2093,"e":2106,"c":"pl-c1"},{"s":2106,"e":2107,"c":"pl-kos"},{"s":2107,"e":2115,"c":"pl-en"},{"s":2115,"e":2116,"c":"pl-kos"},{"s":2116,"e":2122,"c":"pl-smi"},{"s":2122,"e":2123,"c":"pl-kos"},{"s":2123,"e":2131,"c":"pl-c1"},{"s":2131,"e":2132,"c":"pl-kos"},{"s":2132,"e":2145,"c":"pl-c1"},{"s":2145,"e":2146,"c":"pl-kos"},{"s":2146,"e":2149,"c":"pl-c1"},{"s":2149,"e":2150,"c":"pl-kos"},{"s":2150,"e":2151,"c":"pl-kos"},{"s":2151,"e":2155,"c":"pl-en"},{"s":2155,"e":2156,"c":"pl-kos"},{"s":2156,"e":2157,"c":"pl-kos"},{"s":2157,"e":2158,"c":"pl-s1"},{"s":2158,"e":2160,"c":"pl-c1"},{"s":2160,"e":2161,"c":"pl-kos"},{"s":2161,"e":2162,"c":"pl-c1"},{"s":2162,"e":2163,"c":"pl-s1"},{"s":2163,"e":2164,"c":"pl-kos"},{"s":2164,"e":2169,"c":"pl-c1"},{"s":2169,"e":2171,"c":"pl-c1"},{"s":2171,"e":2178,"c":"pl-smi"},{"s":2178,"e":2179,"c":"pl-kos"},{"s":2179,"e":2182,"c":"pl-en"},{"s":2182,"e":2183,"c":"pl-kos"},{"s":2183,"e":2220,"c":"pl-s"},{"s":2220,"e":2221,"c":"pl-kos"},{"s":2221,"e":2222,"c":"pl-s1"},{"s":2222,"e":2223,"c":"pl-kos"},{"s":2223,"e":2228,"c":"pl-c1"},{"s":2228,"e":2229,"c":"pl-kos"},{"s":2229,"e":2230,"c":"pl-kos"},{"s":2230,"e":2231,"c":"pl-s1"},{"s":2231,"e":2232,"c":"pl-kos"},{"s":2232,"e":2248,"c":"pl-en"},{"s":2248,"e":2249,"c":"pl-kos"},{"s":2249,"e":2262,"c":"pl-s"},{"s":2262,"e":2263,"c":"pl-kos"},{"s":2263,"e":2264,"c":"pl-kos"},{"s":2264,"e":2265,"c":"pl-kos"},{"s":2265,"e":2266,"c":"pl-kos"},{"s":2266,"e":2268,"c":"pl-c1"},{"s":2268,"e":2269,"c":"pl-kos"},{"s":2269,"e":2270,"c":"pl-c1"},{"s":2270,"e":2271,"c":"pl-s1"},{"s":2271,"e":2272,"c":"pl-kos"},{"s":2272,"e":2277,"c":"pl-c1"},{"s":2277,"e":2279,"c":"pl-c1"},{"s":2279,"e":2286,"c":"pl-smi"},{"s":2286,"e":2287,"c":"pl-kos"},{"s":2287,"e":2290,"c":"pl-en"},{"s":2290,"e":2291,"c":"pl-kos"},{"s":2291,"e":2356,"c":"pl-s"},{"s":2356,"e":2357,"c":"pl-kos"},{"s":2357,"e":2358,"c":"pl-kos"},{"s":2358,"e":2364,"c":"pl-smi"},{"s":2364,"e":2365,"c":"pl-kos"},{"s":2365,"e":2379,"c":"pl-c1"},{"s":2379,"e":2380,"c":"pl-kos"},{"s":2380,"e":2387,"c":"pl-en"},{"s":2387,"e":2388,"c":"pl-kos"},{"s":2388,"e":2407,"c":"pl-s"},{"s":2407,"e":2408,"c":"pl-kos"},{"s":2408,"e":2421,"c":"pl-s"},{"s":2421,"e":2422,"c":"pl-kos"},{"s":2422,"e":2423,"c":"pl-kos"},{"s":2423,"e":2424,"c":"pl-s1"},{"s":2424,"e":2425,"c":"pl-kos"},{"s":2425,"e":2433,"c":"pl-en"},{"s":2433,"e":2434,"c":"pl-kos"},{"s":2434,"e":2435,"c":"pl-kos"},{"s":2435,"e":2436,"c":"pl-kos"},{"s":2436,"e":2437,"c":"pl-kos"},{"s":2437,"e":2438,"c":"pl-kos"},{"s":2438,"e":2439,"c":"pl-kos"},{"s":2439,"e":2440,"c":"pl-s1"},{"s":2440,"e":2441,"c":"pl-kos"},{"s":2441,"e":2447,"c":"pl-c1"},{"s":2447,"e":2449,"c":"pl-c1"},{"s":2449,"e":2450,"c":"pl-c1"},{"s":2450,"e":2451,"c":"pl-s1"},{"s":2451,"e":2452,"c":"pl-kos"},{"s":2452,"e":2465,"c":"pl-c1"},{"s":2465,"e":2466,"c":"pl-kos"},{"s":2466,"e":2476,"c":"pl-c1"},{"s":2476,"e":2478,"c":"pl-c1"},{"s":2478,"e":2479,"c":"pl-kos"},{"s":2479,"e":2480,"c":"pl-c1"},{"s":2480,"e":2481,"c":"pl-s1"},{"s":2481,"e":2482,"c":"pl-kos"},{"s":2482,"e":2487,"c":"pl-c1"},{"s":2487,"e":2489,"c":"pl-c1"},{"s":2489,"e":2496,"c":"pl-smi"},{"s":2496,"e":2497,"c":"pl-kos"},{"s":2497,"e":2500,"c":"pl-en"},{"s":2500,"e":2501,"c":"pl-kos"},{"s":2501,"e":2558,"c":"pl-s"},{"s":2558,"e":2559,"c":"pl-kos"},{"s":2559,"e":2560,"c":"pl-kos"},{"s":2560,"e":2566,"c":"pl-smi"},{"s":2566,"e":2567,"c":"pl-kos"},{"s":2567,"e":2581,"c":"pl-c1"},{"s":2581,"e":2582,"c":"pl-kos"},{"s":2582,"e":2589,"c":"pl-en"},{"s":2589,"e":2590,"c":"pl-kos"},{"s":2590,"e":2609,"c":"pl-s"},{"s":2609,"e":2610,"c":"pl-kos"},{"s":2610,"e":2626,"c":"pl-s"},{"s":2626,"e":2627,"c":"pl-kos"},{"s":2627,"e":2628,"c":"pl-kos"},{"s":2628,"e":2629,"c":"pl-s1"},{"s":2629,"e":2630,"c":"pl-kos"},{"s":2630,"e":2638,"c":"pl-en"},{"s":2638,"e":2639,"c":"pl-kos"},{"s":2639,"e":2640,"c":"pl-kos"},{"s":2640,"e":2641,"c":"pl-kos"},{"s":2641,"e":2642,"c":"pl-kos"},{"s":2642,"e":2643,"c":"pl-kos"},{"s":2643,"e":2644,"c":"pl-kos"},{"s":2644,"e":2645,"c":"pl-kos"},{"s":2645,"e":2646,"c":"pl-s1"},{"s":2646,"e":2648,"c":"pl-c1"},{"s":2648,"e":2649,"c":"pl-kos"},{"s":2649,"e":2650,"c":"pl-c1"},{"s":2650,"e":2651,"c":"pl-s1"},{"s":2651,"e":2652,"c":"pl-kos"},{"s":2652,"e":2657,"c":"pl-c1"},{"s":2657,"e":2659,"c":"pl-c1"},{"s":2659,"e":2666,"c":"pl-smi"},{"s":2666,"e":2667,"c":"pl-kos"},{"s":2667,"e":2672,"c":"pl-en"},{"s":2672,"e":2673,"c":"pl-kos"},{"s":2673,"e":2719,"c":"pl-s"},{"s":2719,"e":2720,"c":"pl-kos"},{"s":2720,"e":2721,"c":"pl-s1"},{"s":2721,"e":2722,"c":"pl-kos"},{"s":2722,"e":2723,"c":"pl-kos"},{"s":2723,"e":2724,"c":"pl-kos"},{"s":2724,"e":2725,"c":"pl-kos"},{"s":2726,"e":2727,"c":"pl-c1"},{"s":2727,"e":2728,"c":"pl-s1"},{"s":2728,"e":2729,"c":"pl-kos"},{"s":2729,"e":2734,"c":"pl-c1"},{"s":2734,"e":2736,"c":"pl-c1"},{"s":2736,"e":2743,"c":"pl-smi"},{"s":2743,"e":2744,"c":"pl-kos"},{"s":2744,"e":2749,"c":"pl-en"},{"s":2749,"e":2750,"c":"pl-kos"},{"s":2750,"e":2821,"c":"pl-s"},{"s":2821,"e":2822,"c":"pl-kos"},{"s":2823,"e":2824,"c":"pl-c1"},{"s":2824,"e":2825,"c":"pl-s1"},{"s":2825,"e":2826,"c":"pl-kos"},{"s":2826,"e":2831,"c":"pl-c1"},{"s":2831,"e":2833,"c":"pl-c1"},{"s":2833,"e":2840,"c":"pl-smi"},{"s":2840,"e":2841,"c":"pl-kos"},{"s":2841,"e":2844,"c":"pl-en"},{"s":2844,"e":2845,"c":"pl-kos"},{"s":2845,"e":2917,"c":"pl-s"},{"s":2917,"e":2918,"c":"pl-kos"},{"s":2918,"e":2919,"c":"pl-kos"},{"s":2919,"e":2920,"c":"pl-kos"},{"s":2920,"e":2921,"c":"pl-kos"},{"s":2921,"e":2922,"c":"pl-kos"},{"s":2922,"e":2923,"c":"pl-kos"},{"s":2923,"e":2924,"c":"pl-kos"}]],"colorizedLines":null,"csv":null,"csvError":null,"dependabotInfo":{"showConfigurationBanner":false,"configFilePath":null,"networkDependabotPath":"/gzuidhof/coi-serviceworker/network/updates","dismissConfigurationNoticePath":"/settings/dismiss-notice/dependabot_configuration_notice","configurationNoticeDismissed":null},"displayName":"coi-serviceworker.min.js","displayUrl":"https://github.com/gzuidhof/coi-serviceworker/blob/master/coi-serviceworker.min.js?raw=true","headerInfo":{"blobSize":"2.94 KB","deleteTooltip":"You must be signed in to make or propose changes","editTooltip":"You must be signed in to make or propose changes","ghDesktopPath":"https://desktop.github.com","isGitLfs":false,"onBranch":true,"shortPath":"117f9f8","siteNavLoginPath":"/login?return_to=https%3A%2F%2Fgithub.com%2Fgzuidhof%2Fcoi-serviceworker%2Fblob%2Fmaster%2Fcoi-serviceworker.min.js","isCSV":false,"isRichtext":false,"toc":null,"lineInfo":{"truncatedLoc":"2","truncatedSloc":"2"},"mode":"file"},"image":false,"isCodeownersFile":null,"isPlain":false,"isValidLegacyIssueTemplate":false,"issueTemplate":null,"discussionTemplate":null,"language":"JavaScript","languageID":183,"large":false,"planSupportInfo":{"repoIsFork":null,"repoOwnedByCurrentUser":null,"requestFullPath":"/gzuidhof/coi-serviceworker/blob/master/coi-serviceworker.min.js","showFreeOrgGatedFeatureMessage":null,"showPlanSupportBanner":null,"upgradeDataAttributes":null,"upgradePath":null},"publishBannersInfo":{"dismissActionNoticePath":"/settings/dismiss-notice/publish_action_from_dockerfile","releasePath":"/gzuidhof/coi-serviceworker/releases/new?marketplace=true","showPublishActionBanner":false},"rawBlobUrl":"https://github.com/gzuidhof/coi-serviceworker/raw/refs/heads/master/coi-serviceworker.min.js","renderImageOrRaw":false,"richText":null,"renderedFileInfo":null,"shortPath":null,"symbolsEnabled":true,"tabSize":8,"topBannersInfo":{"overridingGlobalFundingFile":false,"globalPreferredFundingPath":null,"showInvalidCitationWarning":false,"citationHelpUrl":"https://docs.github.com/github/creating-cloning-and-archiving-repositories/creating-a-repository-on-github/about-citation-files","actionsOnboardingTip":null},"truncated":false,"viewable":true,"workflowRedirectUrl":null,"symbols":{"timed_out":false,"not_analyzed":false,"symbols":[{"name":"shouldRegister","kind":"function","ident_start":1303,"ident_end":1317,"extent_start":1303,"extent_end":1324,"fully_qualified_name":"shouldRegister","ident_utf16":{"start":{"line_number":1,"utf16_col":1218},"end":{"line_number":1,"utf16_col":1232}},"extent_utf16":{"start":{"line_number":1,"utf16_col":1218},"end":{"line_number":1,"utf16_col":1239}}},{"name":"shouldDeregister","kind":"function","ident_start":1325,"ident_end":1341,"extent_start":1325,"extent_end":1348,"fully_qualified_name":"shouldDeregister","ident_utf16":{"start":{"line_number":1,"utf16_col":1240},"end":{"line_number":1,"utf16_col":1256}},"extent_utf16":{"start":{"line_number":1,"utf16_col":1240},"end":{"line_number":1,"utf16_col":1263}}},{"name":"coepCredentialless","kind":"function","ident_start":1349,"ident_end":1367,"extent_start":1349,"extent_end":1374,"fully_qualified_name":"coepCredentialless","ident_utf16":{"start":{"line_number":1,"utf16_col":1264},"end":{"line_number":1,"utf16_col":1282}},"extent_utf16":{"start":{"line_number":1,"utf16_col":1264},"end":{"line_number":1,"utf16_col":1289}}},{"name":"coepDegrade","kind":"function","ident_start":1375,"ident_end":1386,"extent_start":1375,"extent_end":1393,"fully_qualified_name":"coepDegrade","ident_utf16":{"start":{"line_number":1,"utf16_col":1290},"end":{"line_number":1,"utf16_col":1301}},"extent_utf16":{"start":{"line_number":1,"utf16_col":1290},"end":{"line_number":1,"utf16_col":1308}}},{"name":"doReload","kind":"function","ident_start":1394,"ident_end":1402,"extent_start":1394,"extent_end":1431,"fully_qualified_name":"doReload","ident_utf16":{"start":{"line_number":1,"utf16_col":1309},"end":{"line_number":1,"utf16_col":1317}},"extent_utf16":{"start":{"line_number":1,"utf16_col":1309},"end":{"line_number":1,"utf16_col":1346}}}]}},"copilotInfo":null,"copilotAccessAllowed":false,"csrf_tokens":{"/gzuidhof/coi-serviceworker/branches":{"post":"gMy4Dh77qWNQPwL8W1wTr6rusmfnriszQ6TipItp17OfUz8eN9kYee12gn2FdXHDa5asW6Y19Hoa9a53pAIOnQ"},"/repos/preferences":{"post":"bo6l9KQDy1pOuTyKoO1-vLNkKq9i4fv-E3XSB2ZbWfFixTeUcFEHG2HZfwYusMVTgdi3qsh8mN8R7hpXpAT3gw"}}},"title":"coi-serviceworker/coi-serviceworker.min.js at master · gzuidhof/coi-serviceworker","appPayload":{"helpUrl":"https://docs.github.com","findFileWorkerPath":"/assets-cdn/worker/find-file-worker-1583894afd38.js","findInFileWorkerPath":"/assets-cdn/worker/find-in-file-worker-03b87d52cf57.js","githubDevUrl":null,"enabled_features":{"code_nav_ui_events":false,"overview_shared_code_dropdown_button":false,"react_blob_overlay":false,"copilot_conversational_ux_embedding_update":false,"copilot_smell_icebreaker_ux":true,"copilot_workspace":false,"accessible_code_button":false}}}</script>
...
</style><meta data-hydrostats="publish"/> <!-- --> <!-- --> <button hidden="" data-testid="header-permalink-button" data-hotkey-scope="read-only-cursor-text-area"></button><button hidden=""></button><div><div style="--sticky-pane-height:100vh" class="Box-sc-g0xbh4-0 hOfjFo"><div class="Box-sc-g0xbh4-0 oDGAe"><div class="Box-sc-g0xbh4-0 kowOcT"><div tabindex="0" class="Box-sc-g0xbh4-0 gISSDQ"><div class="Box-sc-g0xbh4-0 fLEPlD"><div class="Box-sc-g0xbh4-0 hPvFuC"></div><div style="--pane-width:320px" class="Box-sc-g0xbh4-0 fFSoPl"></div><div class="Box-sc-g0xbh4-0 bTBnTW"><div role="slider" aria-label="Draggable pane splitter" aria-valuemin="0" aria-valuemax="0" aria-valuenow="0" aria-valuetext="Pane width 0 pixels" tabindex="0" class="Box-sc-g0xbh4-0 bHLmSv"></div></div></div></div><div class="Box-sc-g0xbh4-0 iKqMNA"><div class="Box-sc-g0xbh4-0"></div><div class="Box-sc-g0xbh4-0 FxAyp"><div data-selector="repos-split-pane-content" tabindex="0" class="Box-sc-g0xbh4-0 leYMvG"><div class="Box-sc-g0xbh4-0 KMPzq"><div class="Box-sc-g0xbh4-0 hfKjHv container"><div class="px-3 pt-3 pb-0" id="StickyHeader"><div class="Box-sc-g0xbh4-0 gZWyZE"><div class="Box-sc-g0xbh4-0 dwYKDk"><div class="Box-sc-g0xbh4-0 ibcGmb react-code-view-header-wrap--narrow"><div class="Box-sc-g0xbh4-0 hKaEJF"><h2 class="Heading__StyledHeading-sc-1c1dgg0-0 ixDjro"><button style="--button-color:fg.muted" type="button" aria-label="Expand file tree" data-testid="expand-file-tree-button-mobile" class="types__StyledButton-sc-ws60qy-0 kBQCgV" data-loading="false" data-size="medium" aria-describedby=":Rld9lab:-loading-announcement"><span data-component="buttonContent" class="Box-sc-g0xbh4-0 gUkoLg"><span data-component="leadingVisual" class="Box-sc-g0xbh4-0 hzSPyu"><svg aria-hidden="true" focusable="false" class="octicon octicon-arrow-left" viewBox="0 0 16 16" width="16" height="16" fill="currentColor" style="display:inline-block;user-select:none;vertical-align:text-bottom;overflow:visible"><path d="M7.78 12.53a.75.75 0 0 1-1.06 0L2.47 8.28a.75.75 0 0 1 0-1.06l4.25-4.25a.751.751 0 0 1 1.042.018.751.751 0 0 1 .018 1.042L4.81 7h7.44a.75.75 0 0 1 0 1.5H4.81l2.97 2.97a.75.75 0 0 1 0 1.06Z"></path></svg></span><span data-component="text">Files</span></span></button><span role="tooltip" aria-label="Expand file tree" id="expand-button-file-tree-button" class="Tooltip__TooltipBase-sc-17tf59c-0 hWlpPn tooltipped-se"><button data-component="IconButton" type="button" data-testid="expand-file-tree-button" aria-controls="repos-file-tree" class="types__StyledButton-sc-ws60qy-0 LXqWf prc-Button-IconButton-szpyj" data-loading="false" data-no-visuals="true" data-size="medium" aria-describedby=":R35d9lab:-loading-announcement" aria-labelledby="expand-button-file-tree-button"><svg aria-hidden="true" focusable="false" class="octicon octicon-sidebar-collapse" viewBox="0 0 16 16" width="16" height="16" fill="currentColor" style="display:inline-block;user-select:none;vertical-align:text-bottom;overflow:visible"><path d="M6.823 7.823a.25.25 0 0 1 0 .354l-2.396 2.396A.25.25 0 0 1 4 10.396V5.604a.25.25 0 0 1 .427-.177Z"></path><path d="M1.75 0h12.5C15.216 0 16 .784 16 1.75v12.5A1.75 1.75 0 0 1 14.25 16H1.75A1.75 1.75 0 0 1 0 14.25V1.75C0 .784.784 0 1.75 0ZM1.5 1.75v12.5c0 .138.112.25.25.25H9.5v-13H1.75a.25.25 0 0 0-.25.25ZM11 14.5h3.25a.25.25 0 0 0 .25-.25V1.75a.25.25 0 0 0-.25-.25H11Z"></path></svg></button></span><button hidden="" data-testid="" data-hotkey-scope="read-only-cursor-text-area"></button></h2></div><div class="react-code-view-header-mb--narrow mr-2"><button type="button" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-label="master branch" data-testid="anchor-button" class="types__StyledButton-sc-ws60qy-0 iQGjqs ref-selector-class" data-loading="false" data-size="medium" aria-describedby="branch-picker-repos-header-ref-selector-wide-loading-announcement" id="branch-picker-repos-header-ref-selector-wide"><span data-component="buttonContent" class="Box-sc-g0xbh4-0 gUkoLg"><span data-component="text"><div class="Box-sc-g0xbh4-0 bZBlpz"><div class="Box-sc-g0xbh4-0 lhTYNA"><svg aria-hidden="true" focusable="false" class="octicon octicon-git-branch" viewBox="0 0 16 16" width="16" height="16" fill="currentColor" style="display:inline-block;user-select:none;vertical-align:text-bottom;overflow:visible"><path d="M9.5 3.25a2.25 2.25 0 1 1 3 2.122V6A2.5 2.5 0 0 1 10 8.5H6a1 1 0 0 0-1 1v1.128a2.251 2.251 0 1 1-1.5 0V5.372a2.25 2.25 0 1 1 1.5 0v1.836A2.493 2.493 0 0 1 6 7h4a1 1 0 0 0 1-1v-.628A2.25 2.25 0 0 1 9.5 3.25Zm-6 0a.75.75 0 1 0 1.5 0 .75.75 0 0 0-1.5 0Zm8.25-.75a.75.75 0 1 0 0 1.5.75.75 0 0 0 0-1.5ZM4.25 12a.75.75 0 1 0 0 1.5.75.75 0 0 0 0-1.5Z"></path></svg></div><div class="Box-sc-g0xbh4-0 dbrgmi ref-selector-button-text-container"><span class="Text__StyledText-sc-17v1xeu-0 eMMFM"> <!-- -->master</span></div></div></span><span data-component="trailingVisual" class="Box-sc-g0xbh4-0 hzSPyu"><svg aria-hidden="true" focusable="false" class="octicon octicon-triangle-down" viewBox="0 0 16 16" width="16" height="16" fill="currentColor" style="display:inline-block;user-select:none;vertical-align:text-bottom;overflow:visible"><path d="m4.427 7.427 3.396 3.396a.25.25 0 0 0 .354 0l3.396-3.396A.25.25 0 0 0 11.396 7H4.604a.25.25 0 0 0-.177.427Z"></path></svg></span></span></button><button hidden="" data-hotkey-scope="read-only-cursor-text-area"></button></div><div class="Box-sc-g0xbh4-0 dHJiml react-code-view-header-mb--narrow"><div class="Box-sc-g0xbh4-0 cEytCf"><nav data-testid="breadcrumbs" aria-labelledby="repos-header-breadcrumb-heading" id="repos-header-breadcrumb" class="Box-sc-g0xbh4-0 fzFXnm"><h2 class="Heading__StyledHeading-sc-1c1dgg0-0 jHwwdn sr-only" data-testid="screen-reader-heading" id="repos-header-breadcrumb-heading">Breadcrumbs</h2><ol class="Box-sc-g0xbh4-0 iMnkmv"><li class="Box-sc-g0xbh4-0 ghzDag"><a class="Link__StyledLink-sc-14289xe-0 iuEHTz" sx="[object Object]" data-testid="breadcrumbs-repo-link" href="/gzuidhof/coi-serviceworker/tree/master">coi-serviceworker</a></li></ol></nav><div data-testid="breadcrumbs-filename" class="Box-sc-g0xbh4-0 ghzDag"><span class="Text__StyledText-sc-17v1xeu-0 HlHVj" aria-hidden="true">/</span><h1 class="Heading__StyledHeading-sc-1c1dgg0-0 leHNVT" tabindex="-1" id="file-name-id">coi-serviceworker.min.js</h1></div><div aria-describedby=":R1td9lab:"><button data-component="IconButton" type="button" aria-label="Copy path" tabindex="0" class="types__StyledButton-sc-ws60qy-0 dPmZyJ prc-Button-IconButton-szpyj" data-loading="false" data-no-visuals="true" data-size="small" aria-describedby=":R7td9lab:-loading-announcement"><svg aria-hidden="true" focusable="false" class="octicon octicon-copy" viewBox="0 0 16 16" width="16" height="16" fill="currentColor" style="display:inline-block;user-select:none;vertical-align:text-bottom;overflow:visible"><path d="M0 6.75C0 5.784.784 5 1.75 5h1.5a.75.75 0 0 1 0 1.5h-1.5a.25.25 0 0 0-.25.25v7.5c0 .138.112.25.25.25h7.5a.25.25 0 0 0 .25-.25v-1.5a.75.75 0 0 1 1.5 0v1.5A1.75 1.75 0 0 1 9.25 16h-7.5A1.75 1.75 0 0 1 0 14.25Z"></path><path d="M5 1.75C5 .784 5.784 0 6.75 0h7.5C15.216 0 16 .784 16 1.75v7.5A1.75 1.75 0 0 1 14.25 11h-7.5A1.75 1.75 0 0 1 5 9.25Zm1.75-.25a.25.25 0 0 0-.25.25v7.5c0 .138.112.25.25.25h7.5a.25.25 0 0 0 .25-.25v-7.5a.25.25 0 0 0-.25-.25Z"></path></svg></button></div></div></div></div><div class="react-code-view-header-element--wide"><div class="Box-sc-g0xbh4-0 faNtbn"><div class="d-flex gap-2"> <div><div class="Box-sc-g0xbh4-0 fmQaBv"><span class="TextInputWrapper__TextInputBaseWrapper-sc-1mqhpbi-0 TextInputWrapper-sc-1mqhpbi-1 gwqFqs decvaq TextInput-wrapper" aria-busy="false"><span class="TextInput-icon"><svg aria-hidden="true" focusable="false" class="octicon octicon-search" viewBox="0 0 16 16" width="16" height="16" fill="currentColor" style="display:inline-block;user-select:none;vertical-align:text-bottom;overflow:visible"><path d="M10.68 11.74a6 6 0 0 1-7.922-8.982 6 6 0 0 1 8.982 7.922l3.04 3.04a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215ZM11.5 7a4.499 4.499 0 1 0-8.997 0A4.499 4.499 0 0 0 11.5 7Z"></path></svg></span><input type="text" aria-label="Go to file" role="combobox" aria-controls="file-results-list" aria-expanded="false" aria-haspopup="dialog" autoCorrect="off" spellcheck="false" placeholder="Go to file" data-component="input" class="UnstyledTextInput-sc-14ypya-0 kbCLEG" value=""/><span class="TextInput-icon"></span></span></div><button hidden="" data-testid="" data-hotkey-scope="read-only-cursor-text-area"></button><button hidden=""></button></div><button hidden="" data-testid="" data-hotkey-scope="read-only-cursor-text-area"></button><button hidden=""></button><button hidden="" data-testid="" data-hotkey-scope="read-only-cursor-text-area"></button><button hidden=""></button><button type="button" class="types__StyledButton-sc-ws60qy-0 iLfocZ" data-loading="false" data-no-visuals="true" data-size="medium" aria-describedby=":R2l6d9lab:-loading-announcement"><span data-component="buttonContent" class="Box-sc-g0xbh4-0 gUkoLg"><span data-component="text">Blame</span></span></button><button hidden="" data-testid="" data-hotkey-scope="read-only-cursor-text-area"></button><button data-component="IconButton" type="button" aria-label="More file actions" title="More file actions" data-testid="more-file-actions-button-nav-menu-wide" aria-haspopup="true" aria-expanded="false" tabindex="0" class="types__StyledButton-sc-ws60qy-0 JVsBq js-blob-dropdown-click prc-Button-IconButton-szpyj" data-loading="false" data-no-visuals="true" data-size="medium" aria-describedby=":R156d9lab:-loading-announcement" id=":R156d9lab:"><svg aria-hidden="true" focusable="false" class="octicon octicon-kebab-horizontal" viewBox="0 0 16 16" width="16" height="16" fill="currentColor" style="display:inline-block;user-select:none;vertical-align:text-bottom;overflow:visible"><path d="M8 9a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3ZM1.5 9a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Zm13 0a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Z"></path></svg></button> </div></div></div><div class="react-code-view-header-element--narrow"><div class="Box-sc-g0xbh4-0 faNtbn"><div class="d-flex gap-2"> <button hidden="" data-testid="" data-hotkey-scope="read-only-cursor-text-area"></button><button hidden=""></button><button hidden="" data-testid="" data-hotkey-scope="read-only-cursor-text-area"></button><button hidden=""></button><button type="button" class="types__StyledButton-sc-ws60qy-0 iLfocZ" data-loading="false" data-no-visuals="true" data-size="medium" aria-describedby=":R2l7d9lab:-loading-announcement"><span data-component="buttonContent" class="Box-sc-g0xbh4-0 gUkoLg"><span data-component="text">Blame</span></span></button><button hidden="" data-testid="" data-hotkey-scope="read-only-cursor-text-area"></button><button data-component="IconButton" type="button" aria-label="More file actions" title="More file actions" data-testid="more-file-actions-button-nav-menu-narrow" aria-haspopup="true" aria-expanded="false" tabindex="0" class="types__StyledButton-sc-ws60qy-0 JVsBq js-blob-dropdown-click prc-Button-IconButton-szpyj" data-loading="false" data-no-visuals="true" data-size="medium" aria-describedby=":R157d9lab:-loading-announcement" id=":R157d9lab:"><svg aria-hidden="true" focusable="false" class="octicon octicon-kebab-horizontal" viewBox="0 0 16 16" width="16" height="16" fill="currentColor" style="display:inline-block;user-select:none;vertical-align:text-bottom;overflow:visible"><path d="M8 9a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3ZM1.5 9a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Zm13 0a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Z"></path></svg></button> </div></div></div></div></div></div></div></div><div class="Box-sc-g0xbh4-0 dJxjrT react-code-view-bottom-padding"> <div class="Box-sc-g0xbh4-0 eFxKDQ"></div> <!-- --> <!-- --> </div><div class="Box-sc-g0xbh4-0 dJxjrT"> <!-- --> <!-- --> <button hidden="" data-testid="" data-hotkey-scope="read-only-cursor-text-area"></button><button hidden=""></button><div class="d-flex flex-column border rounded-2 mb-3 pl-1"><div class="Box-sc-g0xbh4-0 dzCJzi"><h2 class="Heading__StyledHeading-sc-1c1dgg0-0 jHwwdn sr-only" data-testid="screen-reader-heading">Latest commit</h2><div style="width:120px" class="Skeleton Skeleton--text" data-testid="loading"> </div><div class="d-flex flex-shrink-0 gap-2"><div data-testid="latest-commit-details" class="d-none d-sm-flex flex-items-center"></div><div class="d-flex gap-2"><h2 class="Heading__StyledHeading-sc-1c1dgg0-0 jHwwdn sr-only" data-testid="screen-reader-heading">History</h2><a href="/gzuidhof/coi-serviceworker/commits/master/coi-serviceworker.min.js" class="types__StyledButton-sc-ws60qy-0 dPmZyJ d-none d-lg-flex LinkButton-module__code-view-link-button--xvCGA flex-items-center fgColor-default" data-loading="false" data-size="small" aria-describedby=":R5dlal9lab:-loading-announcement"><span data-component="buttonContent" class="Box-sc-g0xbh4-0 gUkoLg"><span data-component="leadingVisual" class="Box-sc-g0xbh4-0 hzSPyu"><svg aria-hidden="true" focusable="false" class="octicon octicon-history" viewBox="0 0 16 16" width="16" height="16" fill="currentColor" style="display:inline-block;user-select:none;vertical-align:text-bottom;overflow:visible"><path d="m.427 1.927 1.215 1.215a8.002 8.002 0 1 1-1.6 5.685.75.75 0 1 1 1.493-.154 6.5 6.5 0 1 0 1.18-4.458l1.358 1.358A.25.25 0 0 1 3.896 6H.25A.25.25 0 0 1 0 5.75V2.104a.25.25 0 0 1 .427-.177ZM7.75 4a.75.75 0 0 1 .75.75v2.992l2.028.812a.75.75 0 0 1-.557 1.392l-2.5-1A.751.751 0 0 1 7 8.25v-3.5A.75.75 0 0 1 7.75 4Z"></path></svg></span><span data-component="text"><span class="fgColor-default">History</span></span></span></a><div class="d-sm-none"></div><div class="d-flex d-lg-none"><span role="tooltip" aria-label="History" id="history-icon-button-tooltip" class="Tooltip__TooltipBase-sc-17tf59c-0 hWlpPn tooltipped-n"><a href="/gzuidhof/coi-serviceworker/commits/master/coi-serviceworker.min.js" class="types__StyledButton-sc-ws60qy-0 dPmZyJ LinkButton-module__code-view-link-button--xvCGA flex-items-center fgColor-default" data-loading="false" data-size="small" aria-describedby=":Rpdlal9lab:-loading-announcement history-icon-button-tooltip"><span data-component="buttonContent" class="Box-sc-g0xbh4-0 gUkoLg"><span data-component="leadingVisual" class="Box-sc-g0xbh4-0 hzSPyu"><svg aria-hidden="true" focusable="false" class="octicon octicon-history" viewBox="0 0 16 16" width="16" height="16" fill="currentColor" style="display:inline-block;user-select:none;vertical-align:text-bottom;overflow:visible"><path d="m.427 1.927 1.215 1.215a8.002 8.002 0 1 1-1.6 5.685.75.75 0 1 1 1.493-.154 6.5 6.5 0 1 0 1.18-4.458l1.358 1.358A.25.25 0 0 1 3.896 6H.25A.25.25 0 0 1 0 5.75V2.104a.25.25 0 0 1 .427-.177ZM7.75 4a.75.75 0 0 1 .75.75v2.992l2.028.812a.75.75 0 0 1-.557 1.392l-2.5-1A.751.751 0 0 1 7 8.25v-3.5A.75.75 0 0 1 7.75 4Z"></path></svg></span></span></a></span></div></div></div></div></div><div class="Box-sc-g0xbh4-0 ldRxiI"><div class="Box-sc-g0xbh4-0 fVkfyA container"><div class="Box-sc-g0xbh4-0 gNAmSV react-code-size-details-banner"><div class="Box-sc-g0xbh4-0 jNEwzY react-code-size-details-banner"><div class="Box-sc-g0xbh4-0 bsDwxw text-mono"><div title="2.94 KB" data-testid="blob-size" class="Truncate__StyledTruncate-sc-23o1d2-0 eAtkQz"><span>2 lines (2 loc) · 2.94 KB</span></div></div></div></div><div class="Box-sc-g0xbh4-0 jdLMhu react-blob-view-header-sticky" id="repos-sticky-header"><div class="Box-sc-g0xbh4-0 tOISc"><div class="react-blob-sticky-header"><div class="Box-sc-g0xbh4-0 hqwSEx"><div class="Box-sc-g0xbh4-0 bDVoEr"><div class="Box-sc-g0xbh4-0 kYLlPM"><div class="Box-sc-g0xbh4-0 gYjEmn"><button type="button" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-label="master branch" data-testid="anchor-button" class="types__StyledButton-sc-ws60qy-0 iQGjqs ref-selector-class" data-loading="false" data-size="medium" aria-describedby="branch-picker-repos-header-ref-selector-loading-announcement" id="branch-picker-repos-header-ref-selector"><span data-component="buttonContent" class="Box-sc-g0xbh4-0 gUkoLg"><span data-component="text"><div class="Box-sc-g0xbh4-0 bZBlpz"><div class="Box-sc-g0xbh4-0 lhTYNA"><svg aria-hidden="true" focusable="false" class="octicon octicon-git-branch" viewBox="0 0 16 16" width="16" height="16" fill="currentColor" style="display:inline-block;user-select:none;vertical-align:text-bottom;overflow:visible"><path d="M9.5 3.25a2.25 2.25 0 1 1 3 2.122V6A2.5 2.5 0 0 1 10 8.5H6a1 1 0 0 0-1 1v1.128a2.251 2.251 0 1 1-1.5 0V5.372a2.25 2.25 0 1 1 1.5 0v1.836A2.493 2.493 0 0 1 6 7h4a1 1 0 0 0 1-1v-.628A2.25 2.25 0 0 1 9.5 3.25Zm-6 0a.75.75 0 1 0 1.5 0 .75.75 0 0 0-1.5 0Zm8.25-.75a.75.75 0 1 0 0 1.5.75.75 0 0 0 0-1.5ZM4.25 12a.75.75 0 1 0 0 1.5.75.75 0 0 0 0-1.5Z"></path></svg></div><div class="Box-sc-g0xbh4-0 dbrgmi ref-selector-button-text-container"><span class="Text__StyledText-sc-17v1xeu-0 eMMFM"> <!-- -->master</span></div></div></span><span data-component="trailingVisual" class="Box-sc-g0xbh4-0 hzSPyu"><svg aria-hidden="true" focusable="false" class="octicon octicon-triangle-down" viewBox="0 0 16 16" width="16" height="16" fill="currentColor" style="display:inline-block;user-select:none;vertical-align:text-bottom;overflow:visible"><path d="m4.427 7.427 3.396 3.396a.25.25 0 0 0 .354 0l3.396-3.396A.25.25 0 0 0 11.396 7H4.604a.25.25 0 0 0-.177.427Z"></path></svg></span></span></button><button hidden="" data-hotkey-scope="read-only-cursor-text-area"></button></div><div class="Box-sc-g0xbh4-0 kGqOLL"><div class="Box-sc-g0xbh4-0 fHind"><nav data-testid="breadcrumbs" aria-labelledby="sticky-breadcrumb-heading" id="sticky-breadcrumb" class="Box-sc-g0xbh4-0 fzFXnm"><h2 class="Heading__StyledHeading-sc-1c1dgg0-0 jHwwdn sr-only" data-testid="screen-reader-heading" id="sticky-breadcrumb-heading">Breadcrumbs</h2><ol class="Box-sc-g0xbh4-0 iMnkmv"><li class="Box-sc-g0xbh4-0 ghzDag"><a class="Link__StyledLink-sc-14289xe-0 iuEHTz" sx="[object Object]" data-testid="breadcrumbs-repo-link" href="/gzuidhof/coi-serviceworker/tree/master">coi-serviceworker</a></li></ol></nav><div data-testid="breadcrumbs-filename" class="Box-sc-g0xbh4-0 ghzDag"><span class="Text__StyledText-sc-17v1xeu-0 lauzFl" aria-hidden="true">/</span><h1 class="Heading__StyledHeading-sc-1c1dgg0-0 gbqGBV" tabindex="-1" id="sticky-file-name-id">coi-serviceworker.min.js</h1></div></div></div></div><button style="--button-color:fg.default" type="button" class="types__StyledButton-sc-ws60qy-0 fwExmK" data-loading="false" data-size="small" aria-describedby=":Riptal9lab:-loading-announcement"><span data-component="buttonContent" class="Box-sc-g0xbh4-0 gUkoLg"><span data-component="leadingVisual" class="Box-sc-g0xbh4-0 hzSPyu"><svg aria-hidden="true" focusable="false" class="octicon octicon-arrow-up" viewBox="0 0 16 16" width="16" height="16" fill="currentColor" style="display:inline-block;user-select:none;vertical-align:text-bottom;overflow:visible"><path d="M3.47 7.78a.75.75 0 0 1 0-1.06l4.25-4.25a.75.75 0 0 1 1.06 0l4.25 4.25a.751.751 0 0 1-.018 1.042.751.751 0 0 1-1.042.018L9 4.81v7.44a.75.75 0 0 1-1.5 0V4.81L4.53 7.78a.75.75 0 0 1-1.06 0Z"></path></svg></span><span data-component="text">Top</span></span></button></div></div></div><div class="Box-sc-g0xbh4-0 kTvpNk"><h2 class="Heading__StyledHeading-sc-1c1dgg0-0 jHwwdn sr-only" data-testid="screen-reader-heading">File metadata and controls</h2><div class="Box-sc-g0xbh4-0 iNMjfP"><ul aria-label="File view" class="SegmentedControl__SegmentedControlList-sc-1rzig82-0 lawgDG"><li class="Box-sc-g0xbh4-0 fefCSX"><button aria-current="true" type="button" class="SegmentedControlButton__SegmentedControlButtonStyled-sc-8lkgxl-0 icWBNR"><span class="segmentedControl-content"><div class="Box-sc-g0xbh4-0 segmentedControl-text">Code</div></span></button></li><li class="Box-sc-g0xbh4-0 idgUkN"><button aria-current="false" type="button" class="SegmentedControlButton__SegmentedControlButtonStyled-sc-8lkgxl-0 gLclPK"><span class="segmentedControl-content"><div class="Box-sc-g0xbh4-0 segmentedControl-text">Blame</div></span></button></li></ul><button hidden="" data-testid="" data-hotkey-scope="read-only-cursor-text-area"></button><button hidden="" data-testid="" data-hotkey-scope="read-only-cursor-text-area"></button><div class="Box-sc-g0xbh4-0 jNEwzY react-code-size-details-in-header"><div class="Box-sc-g0xbh4-0 bsDwxw text-mono"><div title="2.94 KB" data-testid="blob-size" class="Truncate__StyledTruncate-sc-23o1d2-0 eAtkQz"><span>2 lines (2 loc) · 2.94 KB</span></div></div></div></div><div class="Box-sc-g0xbh4-0 kcLCKF"><div class="Box-sc-g0xbh4-0 kVWtTz react-blob-header-edit-and-raw-actions"><div class="ButtonGroup-sc-1gxhls1-0 kiEfKw"><a href="https://github.com/gzuidhof/coi-serviceworker/raw/refs/heads/master/coi-serviceworker.min.js" data-testid="raw-button" class="types__StyledButton-sc-ws60qy-0 ifVXZX" data-loading="false" data-no-visuals="true" data-size="small" aria-describedby=":R5csptal9lab:-loading-announcement"><span data-component="buttonContent" class="Box-sc-g0xbh4-0 gUkoLg"><span data-component="text">Raw</span></span></a><button data-component="IconButton" type="button" aria-label="Copy raw content" data-testid="copy-raw-button" class="types__StyledButton-sc-ws60qy-0 gGdPyq prc-Button-IconButton-szpyj" data-loading="false" data-no-visuals="true" data-size="small" aria-describedby=":Rpcsptal9lab:-loading-announcement"><svg aria-hidden="true" focusable="false" class="octicon octicon-copy" viewBox="0 0 16 16" width="16" height="16" fill="currentColor" style="display:inline-block;user-select:none;vertical-align:text-bottom;overflow:visible"><path d="M0 6.75C0 5.784.784 5 1.75 5h1.5a.75.75 0 0 1 0 1.5h-1.5a.25.25 0 0 0-.25.25v7.5c0 .138.112.25.25.25h7.5a.25.25 0 0 0 .25-.25v-1.5a.75.75 0 0 1 1.5 0v1.5A1.75 1.75 0 0 1 9.25 16h-7.5A1.75 1.75 0 0 1 0 14.25Z"></path><path d="M5 1.75C5 .784 5.784 0 6.75 0h7.5C15.216 0 16 .784 16 1.75v7.5A1.75 1.75 0 0 1 14.25 11h-7.5A1.75 1.75 0 0 1 5 9.25Zm1.75-.25a.25.25 0 0 0-.25.25v7.5c0 .138.112.25.25.25h7.5a.25.25 0 0 0 .25-.25v-7.5a.25.25 0 0 0-.25-.25Z"></path></svg></button><span role="tooltip" aria-label="Download raw file" id=":Rdcsptal9lab:" class="Tooltip__TooltipBase-sc-17tf59c-0 hWlpPn tooltipped-n"><button data-component="IconButton" type="button" aria-label="Download raw content" data-testid="download-raw-button" class="types__StyledButton-sc-ws60qy-0 dOuZvu prc-Button-IconButton-szpyj" data-loading="false" data-no-visuals="true" data-size="small" aria-describedby=":Rtcsptal9lab:-loading-announcement"><svg aria-hidden="true" focusable="false" class="octicon octicon-download" viewBox="0 0 16 16" width="16" height="16" fill="currentColor" style="display:inline-block;user-select:none;vertical-align:text-bottom;overflow:visible"><path d="M2.75 14A1.75 1.75 0 0 1 1 12.25v-2.5a.75.75 0 0 1 1.5 0v2.5c0 .138.112.25.25.25h10.5a.25.25 0 0 0 .25-.25v-2.5a.75.75 0 0 1 1.5 0v2.5A1.75 1.75 0 0 1 13.25 14Z"></path><path d="M7.25 7.689V2a.75.75 0 0 1 1.5 0v5.689l1.97-1.969a.749.749 0 1 1 1.06 1.06l-3.25 3.25a.749.749 0 0 1-1.06 0L4.22 6.78a.749.749 0 1 1 1.06-1.06l1.97 1.969Z"></path></svg></button></span></div><button hidden="" data-testid="raw-button-shortcut" data-hotkey-scope="read-only-cursor-text-area"></button><button hidden="" data-testid="copy-raw-button-shortcut" data-hotkey-scope="read-only-cursor-text-area"></button><button hidden="" data-testid="download-raw-button-shortcut" data-hotkey-scope="read-only-cursor-text-area"></button></div><span role="tooltip" aria-label="Open symbols panel" id=":R5sptal9lab:" class="Tooltip__TooltipBase-sc-17tf59c-0 hWlpPn tooltipped-nw"><button data-component="IconButton" type="button" aria-label="Symbols" aria-pressed="false" aria-expanded="false" aria-controls="symbols-pane" data-testid="symbols-button" class="types__StyledButton-sc-ws60qy-0 iZkvjn prc-Button-IconButton-szpyj" data-loading="false" data-no-visuals="true" data-size="small" aria-describedby="symbols-button-loading-announcement" id="symbols-button"><svg aria-hidden="true" focusable="false" class="octicon octicon-code-square" viewBox="0 0 16 16" width="16" height="16" fill="currentColor" style="display:inline-block;user-select:none;vertical-align:text-bottom;overflow:visible"><path d="M0 1.75C0 .784.784 0 1.75 0h12.5C15.216 0 16 .784 16 1.75v12.5A1.75 1.75 0 0 1 14.25 16H1.75A1.75 1.75 0 0 1 0 14.25Zm1.75-.25a.25.25 0 0 0-.25.25v12.5c0 .138.112.25.25.25h12.5a.25.25 0 0 0 .25-.25V1.75a.25.25 0 0 0-.25-.25Zm7.47 3.97a.75.75 0 0 1 1.06 0l2 2a.75.75 0 0 1 0 1.06l-2 2a.749.749 0 0 1-1.275-.326.749.749 0 0 1 .215-.734L10.69 8 9.22 6.53a.75.75 0 0 1 0-1.06ZM6.78 6.53 5.31 8l1.47 1.47a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215l-2-2a.75.75 0 0 1 0-1.06l2-2a.751.751 0 0 1 1.042.018.751.751 0 0 1 .018 1.042Z"></path></svg></button></span><div class="react-blob-header-edit-and-raw-actions-combined"><button data-component="IconButton" type="button" aria-label="Edit and raw actions" title="More file actions" data-testid="more-file-actions-button" aria-haspopup="true" aria-expanded="false" tabindex="0" class="types__StyledButton-sc-ws60qy-0 ggSvLP js-blob-dropdown-click prc-Button-IconButton-szpyj" data-loading="false" data-no-visuals="true" data-size="small" aria-describedby=":Rnsptal9lab:-loading-announcement" id=":Rnsptal9lab:"><svg aria-hidden="true" focusable="false" class="octicon octicon-kebab-horizontal" viewBox="0 0 16 16" width="16" height="16" fill="currentColor" style="display:inline-block;user-select:none;vertical-align:text-bottom;overflow:visible"><path d="M8 9a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3ZM1.5 9a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Zm13 0a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Z"></path></svg></button></div></div></div></div><div></div></div><div class="Box-sc-g0xbh4-0 hGyMdv"><section aria-labelledby="file-name-id-wide file-name-id-mobile" class="Box-sc-g0xbh4-0 dceWRL"><div class="Box-sc-g0xbh4-0 dGXHv"><div id="highlighted-line-menu-positioner" class="position-relative"><div id="copilot-button-positioner" class="Box-sc-g0xbh4-0 bpDFns"><div class="Box-sc-g0xbh4-0 iJOeCH"><div class="Box-sc-g0xbh4-0 jewUnv react-code-file-contents" role="presentation" aria-hidden="true" data-tab-size="8" data-paste-markdown-skip="true" data-hpc="true"><div class="react-line-numbers" style="pointer-events:auto"><div data-line-number="1" class="react-line-number react-code-text" style="padding-right:16px">1</div><div data-line-number="2" class="react-line-number react-code-text" style="padding-right:16px">2</div></div><div class="react-code-lines"><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC1" class="react-file-line html-div" data-testid="code-cell" data-line-number="1" style="position:relative"><span class="pl-c">/*! coi-serviceworker v0.1.7 - Guido Zuidhof and contributors, licensed under MIT */</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC2" class="react-file-line html-div" data-testid="code-cell" data-line-number="2" style="position:relative"><span class="pl-k">let</span> <span class="pl-s1">coepCredentialless</span><span class="pl-c1">=</span><span class="pl-c1">!</span><span class="pl-c1">1</span><span class="pl-kos">;</span><span class="pl-s">&quot;undefined&quot;</span><span class="pl-c1">==</span><span class="pl-k">typeof</span> <span class="pl-smi">window</span>?<span class="pl-kos">(</span><span class="pl-s1">self</span><span class="pl-kos">.</span><span class="pl-en">addEventListener</span><span class="pl-kos">(</span><span class="pl-s">&quot;install&quot;</span><span class="pl-kos">,</span><span class="pl-kos">(</span><span class="pl-kos">(</span><span class="pl-kos">)</span><span class="pl-c1">=&gt;</span><span class="pl-s1">self</span><span class="pl-kos">.</span><span class="pl-en">skipWaiting</span><span class="pl-kos">(</span><span class="pl-kos">)</span><span class="pl-kos">)</span><span class="pl-kos">)</span><span class="pl-kos">,</span><span class="pl-s1">self</span><span class="pl-kos">.</span><span class="pl-en">addEventListener</span><span class="pl-kos">(</span><span class="pl-s">&quot;activate&quot;</span><span class="pl-kos">,</span><span class="pl-kos">(</span><span class="pl-s1">e</span><span class="pl-c1">=&gt;</span><span class="pl-s1">e</span><span class="pl-kos">.</span><span class="pl-en">waitUntil</span><span class="pl-kos">(</span><span class="pl-s1">self</span><span class="pl-kos">.</span><span class="pl-c1">clients</span><span class="pl-kos">.</span><span class="pl-en">claim</span><span class="pl-kos">(</span><span class="pl-kos">)</span><span class="pl-kos">)</span><span class="pl-kos">)</span><span class="pl-kos">)</span><span class="pl-kos">,</span><span class="pl-s1">self</span><span class="pl-kos">.</span><span class="pl-en">addEventListener</span><span class="pl-kos">(</span><span class="pl-s">&quot;message&quot;</span><span class="pl-kos">,</span><span class="pl-kos">(</span><span class="pl-s1">e</span><span class="pl-c1">=&gt;</span><span class="pl-kos">{</span><span class="pl-s1">e</span><span class="pl-kos">.</span><span class="pl-c1">data</span><span class="pl-c1">&amp;&amp;</span><span class="pl-kos">(</span><span class="pl-s">&quot;deregister&quot;</span><span class="pl-c1">===</span><span class="pl-s1">e</span><span class="pl-kos">.</span><span class="pl-c1">data</span><span class="pl-kos">.</span><span class="pl-c1">type</span>?<span class="pl-s1">self</span><span class="pl-kos">.</span><span class="pl-c1">registration</span><span class="pl-kos">.</span><span class="pl-en">unregister</span><span class="pl-kos">(</span><span class="pl-kos">)</span><span class="pl-kos">.</span><span class="pl-en">then</span><span class="pl-kos">(</span><span class="pl-kos">(</span><span class="pl-kos">(</span><span class="pl-kos">)</span><span class="pl-c1">=&gt;</span><span class="pl-s1">self</span><span class="pl-kos">.</span><span class="pl-c1">clients</span><span class="pl-kos">.</span><span class="pl-en">matchAll</span><span class="pl-kos">(</span><span class="pl-kos">)</span><span class="pl-kos">)</span><span class="pl-kos">)</span><span class="pl-kos">.</span><span class="pl-en">then</span><span class="pl-kos">(</span><span class="pl-kos">(</span><span class="pl-s1">e</span><span class="pl-c1">=&gt;</span><span class="pl-kos">{</span><span class="pl-s1">e</span><span class="pl-kos">.</span><span class="pl-en">forEach</span><span class="pl-kos">(</span><span class="pl-kos">(</span><span class="pl-s1">e</span><span class="pl-c1">=&gt;</span><span class="pl-s1">e</span><span class="pl-kos">.</span><span class="pl-en">navigate</span><span class="pl-kos">(</span><span class="pl-s1">e</span><span class="pl-kos">.</span><span class="pl-c1">url</span><span class="pl-kos">)</span><span class="pl-kos">)</span><span class="pl-kos">)</span><span class="pl-kos">}</span><span class="pl-kos">)</span><span class="pl-kos">)</span>:<span class="pl-s">&quot;coepCredentialless&quot;</span><span class="pl-c1">===</span><span class="pl-s1">e</span><span class="pl-kos">.</span><span class="pl-c1">data</span><span class="pl-kos">.</span><span class="pl-c1">type</span><span class="pl-c1">&amp;&amp;</span><span class="pl-kos">(</span><span class="pl-s1">coepCredentialless</span><span class="pl-c1">=</span><span class="pl-s1">e</span><span class="pl-kos">.</span><span class="pl-c1">data</span><span class="pl-kos">.</span><span class="pl-c1">value</span><span class="pl-kos">)</span><span class="pl-kos">)</span><span class="pl-kos">}</span><span class="pl-kos">)</span><span class="pl-kos">)</span><span class="pl-kos">,</span><span class="pl-s1">self</span><span class="pl-kos">.</span><span class="pl-en">addEventListener</span><span class="pl-kos">(</span><span class="pl-s">&quot;fetch&quot;</span><span class="pl-kos">,</span><span class="pl-kos">(</span><span class="pl-k">function</span><span class="pl-kos">(</span><span class="pl-s1">e</span><span class="pl-kos">)</span><span class="pl-kos">{</span><span class="pl-k">const</span> <span class="pl-s1">o</span><span class="pl-c1">=</span><span class="pl-s1">e</span><span class="pl-kos">.</span><span class="pl-c1">request</span><span class="pl-kos">;</span><span class="pl-k">if</span><span class="pl-kos">(</span><span class="pl-s">&quot;only-if-cached&quot;</span><span class="pl-c1">===</span><span class="pl-s1">o</span><span class="pl-kos">.</span><span class="pl-c1">cache</span><span class="pl-c1">&amp;&amp;</span><span class="pl-s">&quot;same-origin&quot;</span><span class="pl-c1">!==</span><span class="pl-s1">o</span><span class="pl-kos">.</span><span class="pl-c1">mode</span><span class="pl-kos">)</span><span class="pl-k">return</span><span class="pl-kos">;</span><span class="pl-k">const</span> <span class="pl-s1">s</span><span class="pl-c1">=</span><span class="pl-s1">coepCredentialless</span><span class="pl-c1">&amp;&amp;</span><span class="pl-s">&quot;no-cors&quot;</span><span class="pl-c1">===</span><span class="pl-s1">o</span><span class="pl-kos">.</span><span class="pl-c1">mode</span>?<span class="pl-k">new</span> <span class="pl-v">Request</span><span class="pl-kos">(</span><span class="pl-s1">o</span><span class="pl-kos">,</span><span class="pl-kos">{</span><span class="pl-c1">credentials</span>:<span class="pl-s">&quot;omit&quot;</span><span class="pl-kos">}</span><span class="pl-kos">)</span>:<span class="pl-s1">o</span><span class="pl-kos">;</span><span class="pl-s1">e</span><span class="pl-kos">.</span><span class="pl-en">respondWith</span><span class="pl-kos">(</span><span class="pl-en">fetch</span><span class="pl-kos">(</span><span class="pl-s1">s</span><span class="pl-kos">)</span><span class="pl-kos">.</span><span class="pl-en">then</span><span class="pl-kos">(</span><span class="pl-kos">(</span><span class="pl-s1">e</span><span class="pl-c1">=&gt;</span><span class="pl-kos">{</span><span class="pl-k">if</span><span class="pl-kos">(</span><span class="pl-c1">0</span><span class="pl-c1">===</span><span class="pl-s1">e</span><span class="pl-kos">.</span><span class="pl-c1">status</span><span class="pl-kos">)</span><span class="pl-k">return</span> <span class="pl-s1">e</span><span class="pl-kos">;</span><span class="pl-k">const</span> <span class="pl-s1">o</span><span class="pl-c1">=</span><span class="pl-k">new</span> <span class="pl-v">Headers</span><span class="pl-kos">(</span><span class="pl-s1">e</span><span class="pl-kos">.</span><span class="pl-c1">headers</span><span class="pl-kos">)</span><span class="pl-kos">;</span><span class="pl-k">return</span> <span class="pl-s1">o</span><span class="pl-kos">.</span><span class="pl-en">set</span><span class="pl-kos">(</span><span class="pl-s">&quot;Cross-Origin-Embedder-Policy&quot;</span><span class="pl-kos">,</span><span class="pl-s1">coepCredentialless</span>?<span class="pl-s">&quot;credentialless&quot;</span>:<span class="pl-s">&quot;require-corp&quot;</span><span class="pl-kos">)</span><span class="pl-kos">,</span><span class="pl-s1">coepCredentialless</span><span class="pl-c1">||</span><span class="pl-s1">o</span><span class="pl-kos">.</span><span class="pl-en">set</span><span class="pl-kos">(</span><span class="pl-s">&quot;Cross-Origin-Resource-Policy&quot;</span><span class="pl-kos">,</span><span class="pl-s">&quot;cross-origin&quot;</span><span class="pl-kos">)</span><span class="pl-kos">,</span><span class="pl-s1">o</span><span class="pl-kos">.</span><span class="pl-en">set</span><span class="pl-kos">(</span><span class="pl-s">&quot;Cross-Origin-Opener-Policy&quot;</span><span class="pl-kos">,</span><span class="pl-s">&quot;same-origin&quot;</span><span class="pl-kos">)</span><span class="pl-kos">,</span><span class="pl-k">new</span> <span class="pl-v">Response</span><span class="pl-kos">(</span><span class="pl-s1">e</span><span class="pl-kos">.</span><span class="pl-c1">body</span><span class="pl-kos">,</span><span class="pl-kos">{</span><span class="pl-c1">status</span>:<span class="pl-s1">e</span><span class="pl-kos">.</span><span class="pl-c1">status</span><span class="pl-kos">,</span><span class="pl-c1">statusText</span>:<span class="pl-s1">e</span><span class="pl-kos">.</span><span class="pl-c1">statusText</span><span class="pl-kos">,</span><span class="pl-c1">headers</span>:<span class="pl-s1">o</span><span class="pl-kos">}</span><span class="pl-kos">)</span><span class="pl-kos">}</span><span class="pl-kos">)</span><span class="pl-kos">)</span><span class="pl-kos">.</span><span class="pl-en">catch</span><span class="pl-kos">(</span><span class="pl-kos">(</span><span class="pl-s1">e</span><span class="pl-c1">=&gt;</span><span class="pl-smi">console</span><span class="pl-kos">.</span><span class="pl-en">error</span><span class="pl-kos">(</span><span class="pl-s1">e</span><span class="pl-kos">)</span><span class="pl-kos">)</span><span class="pl-kos">)</span><span class="pl-kos">)</span><span class="pl-kos">}</span><span class="pl-kos">)</span><span class="pl-kos">)</span><span class="pl-kos">)</span>:<span class="pl-kos">(</span><span class="pl-kos">(</span><span class="pl-kos">)</span><span class="pl-c1">=&gt;</span><span class="pl-kos">{</span><span class="pl-k">const</span> <span class="pl-s1">e</span><span class="pl-c1">=</span><span class="pl-smi">window</span><span class="pl-kos">.</span><span class="pl-c1">sessionStorage</span><span class="pl-kos">.</span><span class="pl-en">getItem</span><span class="pl-kos">(</span><span class="pl-s">&quot;coiReloadedBySelf&quot;</span><span class="pl-kos">)</span><span class="pl-kos">;</span><span class="pl-smi">window</span><span class="pl-kos">.</span><span class="pl-c1">sessionStorage</span><span class="pl-kos">.</span><span class="pl-en">removeItem</span><span class="pl-kos">(</span><span class="pl-s">&quot;coiReloadedBySelf&quot;</span><span class="pl-kos">)</span><span class="pl-kos">;</span><span class="pl-k">const</span> <span class="pl-s1">o</span><span class="pl-c1">=</span><span class="pl-s">&quot;coepdegrade&quot;</span><span class="pl-c1">==</span><span class="pl-s1">e</span><span class="pl-kos">,</span><span class="pl-s1">s</span><span class="pl-c1">=</span><span class="pl-kos">{</span><span class="pl-en">shouldRegister</span>:<span class="pl-kos">(</span><span class="pl-kos">)</span><span class="pl-c1">=&gt;</span><span class="pl-c1">!</span><span class="pl-s1">e</span><span class="pl-kos">,</span><span class="pl-en">shouldDeregister</span>:<span class="pl-kos">(</span><span class="pl-kos">)</span><span class="pl-c1">=&gt;</span><span class="pl-c1">!</span><span class="pl-c1">1</span><span class="pl-kos">,</span><span class="pl-en">coepCredentialless</span>:<span class="pl-kos">(</span><span class="pl-kos">)</span><span class="pl-c1">=&gt;</span><span class="pl-c1">!</span><span class="pl-c1">0</span><span class="pl-kos">,</span><span class="pl-en">coepDegrade</span>:<span class="pl-kos">(</span><span class="pl-kos">)</span><span class="pl-c1">=&gt;</span><span class="pl-c1">!</span><span class="pl-c1">0</span><span class="pl-kos">,</span><span class="pl-en">doReload</span>:<span class="pl-kos">(</span><span class="pl-kos">)</span><span class="pl-c1">=&gt;</span><span class="pl-smi">window</span><span class="pl-kos">.</span><span class="pl-c1">location</span><span class="pl-kos">.</span><span class="pl-en">reload</span><span class="pl-kos">(</span><span class="pl-kos">)</span><span class="pl-kos">,</span><span class="pl-c1">quiet</span>:<span class="pl-c1">!</span><span class="pl-c1">1</span><span class="pl-kos">,</span>...<span class="pl-smi">window</span><span class="pl-kos">.</span><span class="pl-c1">coi</span><span class="pl-kos">}</span><span class="pl-kos">,</span><span class="pl-s1">r</span><span class="pl-c1">=</span><span class="pl-s1">navigator</span><span class="pl-kos">,</span><span class="pl-s1">t</span><span class="pl-c1">=</span><span class="pl-s1">r</span><span class="pl-kos">.</span><span class="pl-c1">serviceWorker</span><span class="pl-c1">&amp;&amp;</span><span class="pl-s1">r</span><span class="pl-kos">.</span><span class="pl-c1">serviceWorker</span><span class="pl-kos">.</span><span class="pl-c1">controller</span><span class="pl-kos">;</span><span class="pl-s1">t</span><span class="pl-c1">&amp;&amp;</span><span class="pl-c1">!</span><span class="pl-smi">window</span><span class="pl-kos">.</span><span class="pl-c1">crossOriginIsolated</span><span class="pl-c1">&amp;&amp;</span><span class="pl-smi">window</span><span class="pl-kos">.</span><span class="pl-c1">sessionStorage</span><span class="pl-kos">.</span><span class="pl-en">setItem</span><span class="pl-kos">(</span><span class="pl-s">&quot;coiCoepHasFailed&quot;</span><span class="pl-kos">,</span><span class="pl-s">&quot;true&quot;</span><span class="pl-kos">)</span><span class="pl-kos">;</span><span class="pl-k">const</span> <span class="pl-s1">i</span><span class="pl-c1">=</span><span class="pl-smi">window</span><span class="pl-kos">.</span><span class="pl-c1">sessionStorage</span><span class="pl-kos">.</span><span class="pl-en">getItem</span><span class="pl-kos">(</span><span class="pl-s">&quot;coiCoepHasFailed&quot;</span><span class="pl-kos">)</span><span class="pl-kos">;</span><span class="pl-k">if</span><span class="pl-kos">(</span><span class="pl-s1">t</span><span class="pl-kos">)</span><span class="pl-kos">{</span><span class="pl-k">const</span> <span class="pl-s1">e</span><span class="pl-c1">=</span><span class="pl-s1">s</span><span class="pl-kos">.</span><span class="pl-en">coepDegrade</span><span class="pl-kos">(</span><span class="pl-kos">)</span><span class="pl-c1">&amp;&amp;</span><span class="pl-c1">!</span><span class="pl-kos">(</span><span class="pl-s1">o</span><span class="pl-c1">||</span><span class="pl-smi">window</span><span class="pl-kos">.</span><span class="pl-c1">crossOriginIsolated</span><span class="pl-kos">)</span><span class="pl-kos">;</span><span class="pl-s1">r</span><span class="pl-kos">.</span><span class="pl-c1">serviceWorker</span><span class="pl-kos">.</span><span class="pl-c1">controller</span><span class="pl-kos">.</span><span class="pl-en">postMessage</span><span class="pl-kos">(</span><span class="pl-kos">{</span><span class="pl-c1">type</span>:<span class="pl-s">&quot;coepCredentialless&quot;</span><span class="pl-kos">,</span><span class="pl-c1">value</span>:<span class="pl-c1">!</span><span class="pl-kos">(</span><span class="pl-s1">e</span><span class="pl-c1">||</span><span class="pl-s1">i</span><span class="pl-c1">&amp;&amp;</span><span class="pl-s1">s</span><span class="pl-kos">.</span><span class="pl-en">coepDegrade</span><span class="pl-kos">(</span><span class="pl-kos">)</span><span class="pl-kos">)</span><span class="pl-c1">&amp;&amp;</span><span class="pl-s1">s</span><span class="pl-kos">.</span><span class="pl-en">coepCredentialless</span><span class="pl-kos">(</span><span class="pl-kos">)</span><span class="pl-kos">}</span><span class="pl-kos">)</span><span class="pl-kos">,</span><span class="pl-s1">e</span><span class="pl-c1">&amp;&amp;</span><span class="pl-kos">(</span><span class="pl-c1">!</span><span class="pl-s1">s</span><span class="pl-kos">.</span><span class="pl-c1">quiet</span><span class="pl-c1">&amp;&amp;</span><span class="pl-smi">console</span><span class="pl-kos">.</span><span class="pl-en">log</span><span class="pl-kos">(</span><span class="pl-s">&quot;Reloading page to degrade COEP.&quot;</span><span class="pl-kos">)</span><span class="pl-kos">,</span><span class="pl-smi">window</span><span class="pl-kos">.</span><span class="pl-c1">sessionStorage</span><span class="pl-kos">.</span><span class="pl-en">setItem</span><span class="pl-kos">(</span><span class="pl-s">&quot;coiReloadedBySelf&quot;</span><span class="pl-kos">,</span><span class="pl-s">&quot;coepdegrade&quot;</span><span class="pl-kos">)</span><span class="pl-kos">,</span><span class="pl-s1">s</span><span class="pl-kos">.</span><span class="pl-en">doReload</span><span class="pl-kos">(</span><span class="pl-s">&quot;coepdegrade&quot;</span><span class="pl-kos">)</span><span class="pl-kos">)</span><span class="pl-kos">,</span><span class="pl-s1">s</span><span class="pl-kos">.</span><span class="pl-en">shouldDeregister</span><span class="pl-kos">(</span><span class="pl-kos">)</span><span class="pl-c1">&amp;&amp;</span><span class="pl-s1">r</span><span class="pl-kos">.</span><span class="pl-c1">serviceWorker</span><span class="pl-kos">.</span><span class="pl-c1">controller</span><span class="pl-kos">.</span><span class="pl-en">postMessage</span><span class="pl-kos">(</span><span class="pl-kos">{</span><span class="pl-c1">type</span>:<span class="pl-s">&quot;deregister&quot;</span><span class="pl-kos">}</span><span class="pl-kos">)</span><span class="pl-kos">}</span><span class="pl-c1">!</span><span class="pl-c1">1</span><span class="pl-c1">===</span><span class="pl-smi">window</span><span class="pl-kos">.</span><span class="pl-c1">crossOriginIsolated</span><span class="pl-c1">&amp;&amp;</span><span class="pl-s1">s</span><span class="pl-kos">.</span><span class="pl-en">shouldRegister</span><span class="pl-kos">(</span><span class="pl-kos">)</span><span class="pl-c1">&amp;&amp;</span><span class="pl-kos">(</span><span class="pl-smi">window</span><span class="pl-kos">.</span><span class="pl-c1">isSecureContext</span>?<span class="pl-s1">r</span><span class="pl-kos">.</span><span class="pl-c1">serviceWorker</span>?<span class="pl-s1">r</span><span class="pl-kos">.</span><span class="pl-c1">serviceWorker</span><span class="pl-kos">.</span><span class="pl-en">register</span><span class="pl-kos">(</span><span class="pl-smi">window</span><span class="pl-kos">.</span><span class="pl-c1">document</span><span class="pl-kos">.</span><span class="pl-c1">currentScript</span><span class="pl-kos">.</span><span class="pl-c1">src</span><span class="pl-kos">)</span><span class="pl-kos">.</span><span class="pl-en">then</span><span class="pl-kos">(</span><span class="pl-kos">(</span><span class="pl-s1">e</span><span class="pl-c1">=&gt;</span><span class="pl-kos">{</span><span class="pl-c1">!</span><span class="pl-s1">s</span><span class="pl-kos">.</span><span class="pl-c1">quiet</span><span class="pl-c1">&amp;&amp;</span><span class="pl-smi">console</span><span class="pl-kos">.</span><span class="pl-en">log</span><span class="pl-kos">(</span><span class="pl-s">&quot;COOP/COEP Service Worker registered&quot;</span><span class="pl-kos">,</span><span class="pl-s1">e</span><span class="pl-kos">.</span><span class="pl-c1">scope</span><span class="pl-kos">)</span><span class="pl-kos">,</span><span class="pl-s1">e</span><span class="pl-kos">.</span><span class="pl-en">addEventListener</span><span class="pl-kos">(</span><span class="pl-s">&quot;updatefound&quot;</span><span class="pl-kos">,</span><span class="pl-kos">(</span><span class="pl-kos">(</span><span class="pl-kos">)</span><span class="pl-c1">=&gt;</span><span class="pl-kos">{</span><span class="pl-c1">!</span><span class="pl-s1">s</span><span class="pl-kos">.</span><span class="pl-c1">quiet</span><span class="pl-c1">&amp;&amp;</span><span class="pl-smi">console</span><span class="pl-kos">.</span><span class="pl-en">log</span><span class="pl-kos">(</span><span class="pl-s">&quot;Reloading page to make use of updated COOP/COEP Service Worker.&quot;</span><span class="pl-kos">)</span><span class="pl-kos">,</span><span class="pl-smi">window</span><span class="pl-kos">.</span><span class="pl-c1">sessionStorage</span><span class="pl-kos">.</span><span class="pl-en">setItem</span><span class="pl-kos">(</span><span class="pl-s">&quot;coiReloadedBySelf&quot;</span><span class="pl-kos">,</span><span class="pl-s">&quot;updatefound&quot;</span><span class="pl-kos">)</span><span class="pl-kos">,</span><span class="pl-s1">s</span><span class="pl-kos">.</span><span class="pl-en">doReload</span><span class="pl-kos">(</span><span class="pl-kos">)</span><span class="pl-kos">}</span><span class="pl-kos">)</span><span class="pl-kos">)</span><span class="pl-kos">,</span><span class="pl-s1">e</span><span class="pl-kos">.</span><span class="pl-c1">active</span><span class="pl-c1">&amp;&amp;</span><span class="pl-c1">!</span><span class="pl-s1">r</span><span class="pl-kos">.</span><span class="pl-c1">serviceWorker</span><span class="pl-kos">.</span><span class="pl-c1">controller</span><span class="pl-c1">&amp;&amp;</span><span class="pl-kos">(</span><span class="pl-c1">!</span><span class="pl-s1">s</span><span class="pl-kos">.</span><span class="pl-c1">quiet</span><span class="pl-c1">&amp;&amp;</span><span class="pl-smi">console</span><span class="pl-kos">.</span><span class="pl-en">log</span><span class="pl-kos">(</span><span class="pl-s">&quot;Reloading page to make use of COOP/COEP Service Worker.&quot;</span><span class="pl-kos">)</span><span class="pl-kos">,</span><span class="pl-smi">window</span><span class="pl-kos">.</span><span class="pl-c1">sessionStorage</span><span class="pl-kos">.</span><span class="pl-en">setItem</span><span class="pl-kos">(</span><span class="pl-s">&quot;coiReloadedBySelf&quot;</span><span class="pl-kos">,</span><span class="pl-s">&quot;notcontrolling&quot;</span><span class="pl-kos">)</span><span class="pl-kos">,</span><span class="pl-s1">s</span><span class="pl-kos">.</span><span class="pl-en">doReload</span><span class="pl-kos">(</span><span class="pl-kos">)</span><span class="pl-kos">)</span><span class="pl-kos">}</span><span class="pl-kos">)</span><span class="pl-kos">,</span><span class="pl-kos">(</span><span class="pl-s1">e</span><span class="pl-c1">=&gt;</span><span class="pl-kos">{</span><span class="pl-c1">!</span><span class="pl-s1">s</span><span class="pl-kos">.</span><span class="pl-c1">quiet</span><span class="pl-c1">&amp;&amp;</span><span class="pl-smi">console</span><span class="pl-kos">.</span><span class="pl-en">error</span><span class="pl-kos">(</span><span class="pl-s">&quot;COOP/COEP Service Worker failed to register:&quot;</span><span class="pl-kos">,</span><span class="pl-s1">e</span><span class="pl-kos">)</span><span class="pl-kos">}</span><span class="pl-kos">)</span><span class="pl-kos">)</span>:<span class="pl-c1">!</span><span class="pl-s1">s</span><span class="pl-kos">.</span><span class="pl-c1">quiet</span><span class="pl-c1">&amp;&amp;</span><span class="pl-smi">console</span><span class="pl-kos">.</span><span class="pl-en">error</span><span class="pl-kos">(</span><span class="pl-s">&quot;COOP/COEP Service Worker not registered, perhaps due to private mode.&quot;</span><span class="pl-kos">)</span>:<span class="pl-c1">!</span><span class="pl-s1">s</span><span class="pl-kos">.</span><span class="pl-c1">quiet</span><span class="pl-c1">&amp;&amp;</span><span class="pl-smi">console</span><span class="pl-kos">.</span><span class="pl-en">log</span><span class="pl-kos">(</span><span class="pl-s">&quot;COOP/COEP Service Worker not registered, a secure context is required.&quot;</span><span class="pl-kos">)</span><span class="pl-kos">)</span><span class="pl-kos">}</span><span class="pl-kos">)</span><span class="pl-kos">(</span><span class="pl-kos">)</span><span class="pl-kos">;</span></div></div></div></div></div></div><div id="copilot-button-container"></div></div><div id="highlighted-line-menu-container"></div></div></div><button hidden="" data-testid="hotkey-button" data-hotkey-scope="read-only-cursor-text-area"></button><button hidden=""></button></section></div></div></div> <!-- --> <!-- --> </div></div></div><div class="Box-sc-g0xbh4-0"></div></div></div></div></div><div id="find-result-marks-container" class="Box-sc-g0xbh4-0 cCoXib"></div><button hidden="" data-testid="" data-hotkey-scope="read-only-cursor-text-area"></button><button hidden=""></button></div> <!-- --> <!-- --> <script type="application/json" id="__PRIMER_DATA_:R0:__">{"resolvedServerColorMode":"day"}</script></div>
</react-app>
</turbo-frame>
